...
for ($x = 1; $x <= $linjeantal; $x++) {
  ...
  print "<td><input class='inputbox' type='text' style='text-align:right' size=4 name=anta$x value='$dkantal[$x]' ";
  print "onchange='javascript:docChange = true;'></td>";
...
print "<td align='center'><input type='submit' style='width:120px; border-radius:4px;' accesskey='g' ";
print "value='Gem' name='save' onclick='javascript:docChange = false;'></td>";
print "<td align='center'><input type=submit style='width:120px; border-radius:4px;' accesskey='o' ";
...
if ($status > 1 && $bogfor == 1) {
  ...
  if ($art == 'KK') {
    ...
    print "<!--Returnér --><input type='submit' style='width:120px; border-radius:4px;' accesskey='m' ";
    print "value='" . findtekst(937, $sprog_id) . "' ";
    print "name='return' onclick='javascript:docChange = false;'></td>";
  } else {
    print "<td align=center><input type=submit style='width:120px; border-radius:4px;'";
    print "accesskey='m' value='" . findtekst('1485|Modtag', $sprog_id) . "' ";
    print "name='receive' onclick='javascript:docChange = false;'></td>";
  }
}
if (!count($posnr) && $id) {
  print "<td align=center><input type='submit' style='width:120px; border-radius:4px;' value='" . findtekst(1099, $sprog_id) . "' ";
  ...
  print "<input type = 'submit' style='width:120px; border-radius:4px;' value='" . $txt . "' ";
  print "name='print' onclick='javascript:docChange = false;'></span></td>";
  print "<td align=center><span title='" . findtekst(1960, $sprog_id) . "'>";
  print "<input type=submit style='width:120px; border-radius:4px;' value='" . findtekst('1959|Udskriv', $sprog_id) . "' ";
  print "name='split' onclick='javascript:docChange = false;'>";
  print "</span></td>";
}
print "<td align=center><span title='" . findtekst(1516, $sprog_id) . "'>";
print "<input type=submit style='width:120px; border-radius:4px;' value='CSV' name='csv' ";
