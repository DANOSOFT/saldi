...
//
// --- kreditor/orderIncludes/closedOrder.php ---patch 5.0.0 --2026-06-11--
//                           LICENSE
//
...
if ($art != 'KK') {
	...
	print "<input type='submit' style='width:120px; border-radius:4px;' value=\"" . findtekst(1493, $sprog_id) . "\" ";
