...
if ($HTTP_POST_VARS)
{
  ...
  $navn=addslashes(trim($HTTP_POST_VARS['navn']));
  ...
  if ($submit=="Slet")
  {
    if (!db_modify("delete from ansatte  where id = '$id'")) 
    {
      echo "fejl 61 :)<br>";
      exit;
    } 
...
print "<td width=\"25%\" bgcolor=\"$bgcolor2\"><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\"><small><a href=kreditorkort.php?returside=$returside&ordre_id=$ordre_id&id=$konto_id&fokus=$fokus accesskey=T>Tilbage</a></small></td>";
