<?
  // -------------------------------------------------------Kreditorordreliste---------------050609   (aammdd)----------
// LICENS
//
...
print "<td width=25% align=right  bgcolor=$bgcolor2 onClick=\"javascript:kordre=window.open('ordre.php?returside=ordreliste.php','kordre','scrollbars=1,resizable=1');ordre.focus();\">$font<small><a accesskey=N href>Ny</a></small></td>";
print "     </tbody></table>";
print "  </td></tr>";
...
print "<tbody>";
print "  <tr>";
# print "  <td align=right width=50><small><b>$font<a href=ordreliste.php?sort=ordrenr>Ordrenr</b></small></td>";
#print "   <td width=100></td>";
#print "   <td><small><b>$font<a href=ordreliste.php?sort=ordredate>Ordredato</b></small></td>";
#print "   <td><small><b>$font<a href=ordreliste.php?sort=levdate>Levdato</b></small></td>";
#print "   <td><small><b>$font<a href=ordreliste.php?sort=kontonr>Leverand&oslash;rnr</b></small></td>";
#print "   <td><small><b>$font<a href=ordreliste.php?sort=firmanavn>Navn</a></b></small></td>";
#print "   <td align=right><small><b>$font<a href=ordreliste.php?sort=sum>Ordresum</a></b></small></td>";
#print "  </tr>";


print "   <td align=right width=50><small><b>$font<a href='ordreliste.php?nysort=ordrenr&sort=$sort&valg=$valg'>Ordrenr.</b></small></td>";
if ($valg=='faktura') {print "<td align=right><small><b>$font<a href='ordreliste.php?nysort=fakturanr&sort=$sort&valg=$valg'>Faktnr.</b></small></td>";}
