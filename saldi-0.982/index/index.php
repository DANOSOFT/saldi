...
elseif ($login=="cookie")
{
  ...
  else  { print"<INPUT TYPE=TEXT NAME=regnskab value='".$_COOKIE['saldi_std']."'>";}
}
...
<INPUT TYPE=HIDDEN name="timestamp" value="<? echo mktime("now"); ?>">
</FORM>
    </tbody></table>
    </td></tr>
    </tbody></table>
  ...
  <tr><td align="center" valign="bottom">
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"><tbody>
      <td width="25%" bgcolor=#bbbbbb><font face="Helvetica, Arial, sans-serif"><small>Copyright (C) 2004-2006 ITz ApS</small></td>
