...
<td width="20%" bgcolor=<? echo "$bgcolor2> $font<small>Ver $version" ?></small></td>
    <td width="60%" bgcolor=<? echo "$bgcolor2 align = \"center\">$font "?><a href=komigang.html><small>Vejledning</small></td>
    <td width="20%" bgcolor=<? echo "$bgcolor2 align = \"right\">$font "?><a href=logud.php accesskey=L><small>Logud</small></td>
    </tbody></table></td></tr><tr><td align="center" valign="center">
    <table width="20%" align="center" border="1" cellspacing="0" cellpadding="0"><tbody>
        <tr>
          <td colspan="5" align="center"><font face="Helvetica, Arial, sans-serif" color="#000066"><big><big><b>SQL FINANS</b></big></big></td>
        </tr><tr>
          <td bgcolor=<? echo "$bgcolor2" ?> align="center"><font face="Helvetica, Arial, sans-serif" color="#000066"><b>Administrations menu</b></td>
        </tr><tr>
  ...
  <tr><td align="center" valign="bottom">
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"><tbody>
      <td width="25%" bgcolor="<? print $bgcolor2 ?>"><font face="Helvetica, Arial, sans-serif" color="#000066"><small>Copyright (c) 2004-2005 ITz ApS</small></td>
