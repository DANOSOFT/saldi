<?
// ---------------------------------------------------finans/kladdeliste.php----------Patch 0.971---------
// LICENS
//
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"><tbody>
  <tr><td height = "25" align="center" valign="top">
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"><tbody>
      ...
      <td width="50%" bgcolor="<? echo $bgcolor2 ?>" align="center"><font face="Helvetica, Arial, sans-serif" color="#000066"><small>Kladdeliste</small></td>
      <td width="25%" bgcolor="<? echo $bgcolor2 ?>" align="right" onClick="javascript:kladde=window.open('kassekladde.php?returside=kladdeliste.php&tjek=-1','kladde','scrollbars=1,resizable=1');kladde.focus();"><font face="Helvetica, Arial, sans-serif" color="#000066"><small><a href accesskey=N>Ny</a></small></td>
      </tbody></table>
  </td></tr>
 <tr><td valign="top">
...
#$sqhost = "localhost";
  ...
  while ($row = db_fetch_array($query))
  {
    ...
    {
      print "<td onClick=\"javascript:$kladde=window.open('kassekladde.php?tjek=$row[id]&kladde_id=$row[id]&returside=kladdeliste.php','$kladde','scrollbars=1,resizable=1');$kladde.focus();\"><small>$font<span style=\"text-decoration: underline;\">$row[id]</a></span></small></td>";
    }
  ...
  while ($row = db_fetch_array($query))
  {
    ...
    print "<tr bgcolor=\"$linjebg\">";
    print "<td onClick=\"javascript:$kladde=window.open('kassekladde.php?kladde_id=$row[id]&returside=kladdeliste.php','$kladde','scrollbars=1,resizable=1');$kladde.focus();\"><small>$font<span style=\"text-decoration: underline;\">$row[id]</a></span></small></td>";
