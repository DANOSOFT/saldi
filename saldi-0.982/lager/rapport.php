...
if ($HTTP_POST_VARS['submit'])
{
  ...
  $varegruppe=trim($HTTP_POST_VARS['varegruppe']);
  $maaned_fra=$HTTP_POST_VARS['maaned_fra'];
  $maaned_til=$HTTP_POST_VARS['maaned_til'];
  $md=$HTTP_POST_VARS['md'];
  list ($varenr_fra, $firmanavn) = split(":", $HTTP_POST_VARS['varenr_fra']);
  list ($varenr_til, $firmanavn) = split(":", $HTTP_POST_VARS['varenr_til']);
...
#  $varenr_fra=$varenr_fra*1;
#  $varenr_til=$varenr_til*1;
  ...
  while ($row = db_fetch_array($query))
  {
    ...
    $vare_id[$x]=$row[id];
    $varenr[$x]=$row['varenr'];
    $varenavn[$x]=substr($row['beskrivelse'],0,60);
...
#  global $connection;
  ...
  if (strlen($maaned_fra)>2) {
    ...
    print "$font <a accesskey=t href=\"rapport.php?varegruppe=$varegruppe&regnaar=$regnaar&maaned_fra=$maaned_fra&maaned_til=$maaned_til&varenr_fra=$varenr_fra&varenr_til=$varenr_til\"><small><small>Luk</small></small></a><br><br>";
  }
...
#  print "<tr><td colspan=5>Firmanavn</td></tr>";
  $kontonr=array();
  $x=0;
  $query = db_select("select id from varer where gruppe=$gruppenr and varenr>='$varenr_fra' and varenr<='$varenr_til' order by varenr");
  while ($row = db_fetch_array($query))
  {
    $x++;
    $vare_id[$x]=$row[id];
...
#    print "<tr><td colspan=8><hr></td></tr>";
    ...
    print "<tr><td><br></td></tr>";
    print "<tr><td colspan=3><small><small>$row[varenr]</small></small></td></tr>";
    print "<tr><td colspan=3><small><small>$row[beskrivelse]</small></small></td></tr>";
    print "<tr><td><br></td></tr>";
    print "<tr><td width=12.5%><small><small>Dato</td><td align=right width=12.5%><small><small>Antal</small></small></td><td align=right width=12.5%><small><small>Købsordre</small></small></td><td align=right width=12.5%><small><small>Salgsordre</small></small></td><td align=right width=12.5%><small><small>K&oslash;bspris</small></small></td><td align=right width=12.5%><small><small>Salgspris</small></small></td><td align=right width=12.5%><small><small>DB</small></small></td><td align=right width=12.5%><small><small>DG</small></small></td></tr>";
    print "<tr><td colspan=8><hr></td></tr>";
    ...
    while ($row = db_fetch_array($query)) {
      ...
      print "<tr><td><small><small>".dkdato($row[fakturadate])."</small></small></td><td align=right><small><small>$row[antal]</small></small></td><td align=right onClick=\"javascript:k_ordre=window.open('../kreditor/ordre.php?id=$r2[ordre_id]','k_ordre','width=800,height=400,scrollbars=1,resizable=1')\"><small><small><u>$r3[ordrenr]</u></small></small></td><td align=right onClick=\"javascript:k_ordre=window.open('../debitor/ordre.php?id=$row[ordre_id]','k_ordre','width=800,height=400,scrollbars=1,resizable=1')\"><small><small><u>$r1[ordrenr]</u></small></small></td>";
    ...
    while ($row = db_fetch_array($query)) {
      ...
      print "<tr><td><small><small>".dkdato($row[fakturadate])."(KN)</small></small></td><td align=right><small><small>$row[antal]</small></small></td><td align=right onClick=\"javascript:k_ordre=window.open('../kreditor/ordre.php?id=$r2[ordre_id]','k_ordre','width=800,height=400,scrollbars=1,resizable=1')\"><small><small><u>$r2[ordrenr]</u></small></small></td><td align=right onClick=\"javascript:k_ordre=window.open('../debitor/ordre.php?id=$row[ordre_id]','k_ordre','width=800,height=400,scrollbars=1,resizable=1')\"><small><small><u>$r1[ordrenr]</u></small></small></td>";
    ...
    print "<tr><td></td>";
    $tmp=dkdecimal($antal);
    print "<td align=right><small><small>$tmp</small></small></td><td></td><td></td>";
  ...
  print "<tr><td colspan=8><hr></td></tr>";
  print "<tr><td></td>";
  print "<td align=right><small><small></small></small></td><td></td><td></td>";
  $tmp=dkdecimal($totalkob);
  print "<td align=right><small><small><b>$tmp</b></small></small></td>";
  ...
  $tmp=dkdecimal($dg);
  print "<td align=right><small><small><b>$tmp</b></small></small></td></tr>";
