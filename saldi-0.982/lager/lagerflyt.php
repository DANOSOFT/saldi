...
if ($HTTP_POST_VARS)
{
  ...
  $max_antal=$HTTP_POST_VARS['max_antal'];
  $batch_kob_id=$HTTP_POST_VARS['batch_kob_id'];
  $batch_kob_antal=$HTTP_POST_VARS['batch_kob_antal'];
  $nyt_lager=$HTTP_POST_VARS['nyt_lager'];
