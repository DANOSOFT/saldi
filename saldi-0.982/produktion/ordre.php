...
// ----------------------------------------------------------------------
  ...
  if ($HTTP_POST_VARS)
  {
    ...
    for ($x=0; $x<=$linjeantal;$x++)
    {
      ...
      $y="anta".$x;
      $antal[$x]=usdecimal($HTTP_POST_VARS[$y]);
      $y="leve".$x;
...
#    print "<input type=hidden name=id value=$row[id]>";
    ...
    print "<tr><td width=100>$font<small><b>Kontnr.</td><td width=100>$font<small>$row[kontonr]</td></tr>";
...
#    print "<tr><td>$font<small>$lev_adr</td></tr>";
  ...
  else
  {
    ...
    $ordre_id=$row[id];
    print "<tr><td width=33%><table cellpadding=0 cellspacing=0 border=0 width=100>";
    print "<tr><td witdh=200>$font<small>Kontnr.</td><td colspan=2>$font<small><input readonly=readonly size=25 name=kontonr onfocus=\"document.forms[0].fokus.value=this.name;\" value='$row[kontonr]'></td></tr>";
...
global $bgcolor2;
  ...
  if ($returside != "ordre.php") {print "<td width=\"25%\" bgcolor=\"$bgcolor2\"><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\"><small><a href=ordreliste.php accesskey=T>Tilbage</a></small></td>";}
  else {print "<td width=\"25%\" bgcolor=\"$bgcolor2\"><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\"><small><a href=ordre.php?id=$id accesskey=T>Tilbage</a></small></td>";}
