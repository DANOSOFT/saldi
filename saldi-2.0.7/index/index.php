<?php
// -----------index/index.php-----------lap 2.0.7------2009-05-19-11:39--
// LICENS
//
...
<INPUT TYPE=HIDDEN name="timestamp" value="<?php echo mktime("now"); ?>">
	...
	<tr><td align="center" valign="bottom">
		<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"><tbody>
			<td style="border: 1px solid rgb(180, 180, 255); padding: 0pt 0pt 1px;" align="left" background="../img/grey1.gif" width="100%" bgcolor="<?php print $bgcolor2 ?>"><font face="Helvetica, Arial, sans-serif" color="#000000">&nbsp;Copyright&nbsp;&copy;&nbsp;2003-2009&nbsp;DANOSOFT&nbsp;ApS</td>
		</tbody></table>
	</td></tr>
</tbody></table>
</head>
