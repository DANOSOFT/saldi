<?php
// -----------------------includes/genberegn.php-------lap 2.0.7------2009.05.12---
// LICENS
//
...
#echo "slutdato $slutdato<br>";		
		...
		while ($r1 = db_fetch_array($q1)) {
			...
			db_modify("update kontoplan set  saldo =$primo+$saldo where id='$r1[id]'",__FILE__ . " linje " . __LINE__);
		}
		...
		while ($r1 = db_fetch_array($q1)) {
			...
			$saldo[$x]=round($r1['saldo']+0.0001,2);
			...
			if ($kontotype[$x]=='Z') {
				...
				db_modify("update kontoplan set  saldo =$saldo[$x] where id='$r1[id]'",__FILE__ . " linje " . __LINE__);
 			}
 		}
