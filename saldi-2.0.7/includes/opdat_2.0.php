<?php
// -------------------------- includes/opdat_2.0.php-------lap 2.0.7 ------2009.05.19---22:45-------
// LICENS
//
...
#		db_modify("update grupper set box3='',box4='',box5='',box8='',box9='' where art = 'DIV' and kodenr = '2'");
		...
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Tilbud', 1, 5, 1, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Hermed fremsendes tilbud', 1, 5, 2, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		$tmp='Ordrebekræftelse';
		if ($db_encode=="UTF8") $tmp=utf8_encode($tmp);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('$tmp', 2, 5, 1, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		$tmp='Hermed fremsendes ordrebekræftelse';
		if ($db_encode=="UTF8") $tmp=utf8_encode($tmp);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('$tmp', 2, 5, 2, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Faktura', 4, 5, 1, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Hermed fremsendes faktura', 4, 5, 2, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Kreditnota', 5, 5, 1, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Hermed fremsendes kreditnota', 5, 5, 2, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Rykker', 6, 5, 1, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Hermed fremsendes tilbud', 6, 5, 2, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Rykker', 7, 5, 1, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Hermed fremsendes tilbud', 7, 5, 2, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Rykker', 8, 5, 1, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
		db_modify("insert into formularer (beskrivelse, formular, art, xa, ya, xb, yb, str, color, font, fed, kursiv, side, placering, sprog) values ('Hermed fremsendes tilbud', 8, 5, 2, 0, 0, 0, 10, 0, '', '', '', '', '', 'Dansk')",__FILE__ . " linje " . __LINE__);
