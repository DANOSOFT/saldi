<?php
// -------------systemdata/valutakort.php----lap 1.9.2b-------08.04.08-----------
// LICENS
//
...
if ($kodenr) {
	...
	print "<tr><td title='Den dato hvorfra kursen er g&aelig;ldende'>$font Dato</td>
		<td align=center title='V&aelig;rdien i DKR af 100 $valuta'>$font Kurs</td>
		<td align=center title='Kontonummer fra kontoplanen som skal bruges til valutakursdifferencer og &oslash;reafrunding'>$font Diff. konto</td>
		</tr>";
