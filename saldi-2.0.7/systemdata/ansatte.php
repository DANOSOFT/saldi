<?php
// -------systemdata/ansatte.php--------lap 2.0.7-------2009-05-20-------
// LICENS
//
...
print "<td width=\"10%\" $top_bund<font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\">$font<small><a href=stamkort.php?returside=$returside&id=$konto_id&fokus=$fokus accesskey=L>Luk</a></small></td>";
print "<td width=\"80%\" $top_bund><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\">$font<small>$row[firmanavn] - Ansatte</small></td>";
print "<td width=\"10%\" $top_bund><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\">$font<small><a href=ansatte.php?returside=$returside&fokus=$fokus&konto_id=$konto_id accesskey=N>Ny</a><br></small></td>";
print "</tbody></table>";
print "</td></tr>";
