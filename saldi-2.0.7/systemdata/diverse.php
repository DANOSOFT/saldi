<?php
// -------------------- systemdata/diverse.php ------ patch 2.0.7 --2009-05-18--------
// LICENS..
//
...
echo "id $id<br>";		
		...
		elseif (!$id){
#echo "insert into grupper (beskrivelse,kodenr,art,box1,box2,box3,box4,box5) values ('e-mail tekster','1','MAIL','$box1','$box2','$box3','$box4','$box5')<br>";			
...
######################################################################################
		...
		if ($_POST['submit']=="Eksport&eacute;r") {
		...
		elseif ($_POST['submit']=="Import&eacute;r") {
...
print "<table cellpadding=\"1\" cellspacing=\"31\" border=\"0\" width=\"100%\"><tbody>";

print "<tr><td><br></td>";
print "<td valign=\"top\">";
print "<table cellpadding=\"1\" cellspacing=\"5\" border=\"0\"><tbody>";
...
print "<tr><td align=left $top_bund>&nbsp;<a href=diverse.php?sektion=docubizz>DocuBizz</a></td></tr>";
...
function kontoplan_io() 
{
	...
	print "<tr><td colspan=6><br></td></tr>";
	print "<tr><td colspan=2>Eksport&eacute;r kontoplan</td><td align=center><SELECT NAME=regnskabsaar title='V&aelig;lg det regnskabs&aring;r hvorfra kontoplanen skal eksporteres'>";
	if ($box3[$x]) print"<option>$box3[$x]</option>";
	for ($x=1; $x<=$antal_regnskabsaar; $x++) { 
		print "<option>$kodenr[$x] : $beskrivelse[$x]</option>";
	}
	print "</SELECT></td>";;
	print "<td align = center><input type=submit accesskey=\"e\" value=\"Eksport&eacute;r\" name=\"submit\"></td><tr>";
	print "<tr><td colspan=3>Import&eacute;r kontoplan (erstatter kontoplanen for nyeste regnskabs&aring;r) </td>";
	print "<td align = center><input type=submit accesskey=\"i\" value=\"Import&eacute;r\" name=\"submit\"></td><tr>";
#	print "</tbody></table></td></tr>";
	print "</form>";
...
function kreditor_io() 
{
	...
	print "<tr><td colspan=6><br></td></tr>";
	print "<tr><td colspan=3>Eksport&eacute;r kontoplan</td>";
	print "<td align = center><input type=submit accesskey=\"e\" value=\"Eksport&eacute;r\" name=\"submit\"></td><tr>";
	print "<tr><td colspan=3>Import&eacute;r kontoplan (erstatter kontoplanen for nyeste regnskabs&aring;r) </td>";
	print "<td align = center><input type=submit accesskey=\"i\" value=\"Import&eacute;r\" name=\"submit\"></td><tr>";
#	print "</tbody></table></td></tr>";
