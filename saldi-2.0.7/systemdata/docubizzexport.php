...
// ----------- utils/ducubizzexport.php --- lap 2.0.7 ---- 2009.03.25 -----------
// LICENS
//
...
if ($fp) {
	$q = db_select("SELECT 
			...
			from adresser, grupper where adresser.art = 'K' and adresser.gruppe=grupper.kodenr and grupper.art='KG' order by adresser.kontonr",__FILE__ . " linje " . __LINE__);
