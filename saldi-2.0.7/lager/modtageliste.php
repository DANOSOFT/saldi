<?php
// ---------lager/modtageliste.php----------lap 2.0.7-------2009-05-15---17:22---------
// LICENS
//
...
print "<table width=\"100%\" height=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tbody>
		...
		<td width=\"10%\" title=\"Klik her for at oprette en ny modtagelse\" $top_bund onClick=\"javascript:liste=window.open('modtagelse.php?returside=modtageliste.php&tjek=-1','liste','<?php echo $jsvars ?>');liste.focus();\"><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\"><?php echo\"<a href=modtageliste.php?sort=$sort&rf=$rf&vis=$vis accesskey=N>\"?>Ny</a></td>
		</tbody></table>
		</td></tr>
		<tr><td valign=\"top\">
...
#		print "<td> $row[id]<br></td>";
	...
	while ($row = db_fetch_array($query)){
		...
		print "<tr bgcolor=\"$linjebg\">";
		print "<td  onMouseOver=\"this.style.cursor = 'pointer'\"; onClick=\"javascript:$liste=window.open('modtagelse.php?liste_id=$row[id]&returside=modtageliste.php','$liste','".$jsvars."');$liste.focus();\"><span style=\"text-decoration: underline;\">$row[id]</a></span></td>";
#		print "<td><a href=modtagelse.php?liste_id=$row[id]&returside=modtageliste.php>$row[id]</a><br></td>";
		$listedato=dkdato($row['initdate']);
		print "<td>$listedato<br></td>";
		print "<td>".htmlentities(stripslashes($row['init_af']))."<br></td>";
