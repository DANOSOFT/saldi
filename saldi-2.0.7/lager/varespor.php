...
// ------------lager/varespor.php------------patch 2.0.6------2009.02.27---
// LICENS
//
...
$q = db_select("select id, firmanavn, levdate, ordrenr, art from ordrer where status > 0 and status < 3 and (art = 'KO' or art = 'KK') order by levdate",__FILE__ . " linje " . __LINE__);
