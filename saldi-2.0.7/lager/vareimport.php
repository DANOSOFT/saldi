<?php
// -------------------------------------------lager/vareimport.pgp---------lap 2.0.7----2009-05-15----
// LICENS
//
...
if ($fp) {
	...
	if ($linjefarve) print "<BODY onLoad=\"javascript:alert('R&oslash;de linjer vil ikke blive importeret - varegruppe findes ikke')\">";
}
 fclose($fp);
print "</tbody></table>";
print "</td></tr>";
