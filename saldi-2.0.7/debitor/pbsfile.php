...
@session_start();
$s_id=session_id();
// ------------debitor/pbsfile.php------- patch 2.0.7 ---2009.05.12------
// LICENS
//
...
if ($afslut || $afsendt) print "<tr><td title=\"&Aring;bner PBS filen. H&oslash;jreklik for at gemme\" align=center> Klik her: <a href=\"$filnavn\">&Aring;ben PBSfil</a></td></tr>";
