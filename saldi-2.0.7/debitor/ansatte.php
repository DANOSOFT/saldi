...
// -------- debitor/ansatte.php (modul nr. 6)----------lap 2.0.7 ----- 2009.05.18----------
// LICENS
//
...
print "<td>Navn</td><td><br></td><td><input type=text size=25 name=navn value=\"$navn\"></td></tr>";
print "<tr><td>Adresse</td><td><br></td><td><input type=text size=25 name=addr1 value=\"$addr1\"></td>";
print "<td><br></td>";
print "<td>Adresse2</td><td><br></td><td><input type=text size=25 name=addr2 value=\"$addr2\"></td></tr>";
print "<tr><td>Postnr</td><td><br></td><td><input type=text size=6 name=postnr value=\"$postnr\"></td>";
print "<td><br></td>";
print "<td>By</td><td><br></td><td><input type=text size=25 name=bynavn value=\"$bynavn\"></td></tr>";
print "<tr><td>E-mail</td><td><br></td><td><input type=text size=25 name=email value=\"$email\"></td>";
print "<td><br></td>";
#print "<td>CVR. nr.</td><td><br></td><td><input type=text size=10 name=cprnr value=\"$cprnr\"></td></tr>";
print "<td>Mobil</td><td><br></td><td><input type=text size=10 name=mobil value=\"$mobil\"></td></tr>";
print "<tr><td>Lokalnr.</td><td><br></td><td><input type=text size=10 name=tlf value=\"$tlf\"></td>";
print "<td><br></td>";
print "<td>Lokal fax</td><td><br></td><td><input type=text size=10 name=fax value=\"$fax\"></td></tr>";
print "<td><br></td>";
