<?php
// ------------debitor/jobliste.php---lap 2.0.6------2009-03-04----------
// LICENS
//
...
print "<td width=10% $top_bund><a href=../includes/luk.php accesskey=L>".findtekst(30,$sprog_id)."</a></td>";
# print "<td width=50%$top_bund align=center>Kundejobr</td>";
...
print "<td width=30% $top_bund align=center><br></td>";
if ($popup) print "<td width=10% $top_bund onClick=\"javascript:job=window.open('jobkort.php?returside=jobliste.php','job','scrollbars=1,resizable=1');job.focus();\"><a accesskey=N href=jobliste.php?sort=$sort>".findtekst(39,$sprog_id)."</a></td>";
else print "<td width=10% $top_bund><a href=jobkort.php?returside=jobliste.php accesskey=N>".findtekst(39,$sprog_id)."</a></td>";
print "</td></tr>\n";
...
print "<tbody>";
print "<tr>";
print "<td><b><a href='jobliste.php?nysort=kolonne01&sort=$sort&valg=$valg$hreftext'>".findtekst(6,$sprog_id)."</b></td>";
print "<td><b><a href='jobliste.php?nysort=kolonne02&sort=$sort&valg=$valg$hreftext'>".findtekst(35,$sprog_id)."</b></td>";
print "<td><b><a href='jobliste.php?nysort=kolonne03&sort=$sort&valg=$valg$hreftext'>".findtekst(36,$sprog_id)."</b></td>";
print "<td><b><a href='jobliste.php?nysort=kolonne04&sort=$sort&valg=$valg$hreftext'>".findtekst(37,$sprog_id)."</a></b></td>";
print "<td><b><a href='jobliste.php?nysort=kolonne05&sort=$sort&valg=$valg$hreftext'>".findtekst(7,$sprog_id)."</a></b></td>";
print "<td><b><a href='jobliste.php?nysort=kolonne06&sort=$sort&valg=$valg$hreftext'>".findtekst(9,$sprog_id)."</a></b></td>";
print "<td><b><a href='jobliste.php?nysort=kolonne07&sort=$sort&valg=$valg$hreftext'>".findtekst(13,$sprog_id)."</a></b></td>";
print "<td><b><a href='jobliste.php?nysort=kolonne08&sort=$sort&valg=$valg$hreftext'>".findtekst(27,$sprog_id)."</a></b></td>";
print "</a></b></td>";
...
print "<form name=jobliste action=jobliste.php method=post>";
