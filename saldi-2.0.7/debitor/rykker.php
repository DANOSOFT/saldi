<?php
// -----------debitor/rykker.php---------lap 2.0.7-------2009-05-19--22:45----
// LICENS
//
...
if ($rykker_id) {
	...
	$betalingsbet = trim($row['betalingsbet'],ENT_COMPAT,$charset);
...
print "</td></tr><tr><td align=center colspan=3><table cellpadding=0 cellspacing=0 border=1 width=100%><tbody>";
	...
	$sum=0;
	$ialt=0;
	$q = db_select("select * from ordrelinjer where ordre_id = '$rykker_id' order by posnr",__FILE__ . " linje " . __LINE__);
...
#	print "<td align=center><input type=submit value=\"Tilbage\" name=\"submit\"></td>";
	if ($status<3) print "<td align=center><input type=submit value=\"Opdat&eacute;r\" name=\"submit\"></td>";
