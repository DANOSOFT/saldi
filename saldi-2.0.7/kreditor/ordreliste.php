<?php
// --------------------------kreditor/ordreliste.php---lap 2.0.5------2009-02-26------
// LICENS
//
...
if ($valg) {
	...
	list ($ordrenumre, $kontonumre, $fakturanumre, $ordredatoer, $lev_datoer, $fakturadatoer, $genfaktdatoer, $summer, $firma, $kontoid, $ref[0], $sort, $valg, $nysort) = split(";", $_COOKIE['kred_ord_lst']);#
}
