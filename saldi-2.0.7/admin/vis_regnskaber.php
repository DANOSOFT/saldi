...
// --------------------------------/admin/vis_regnskaber.php-----patch 2.0.7------2009-05-14--------
// LICENS
//
...
$sort2=isset($_GET['sort2'])? $_GET['sort2']:NULL;
...
# print "<tr><td colspan=5 align=center><input type=submit value=\"Opdat&eacute;r\" name=\"submit\"></td></tr>";
$x=0;
