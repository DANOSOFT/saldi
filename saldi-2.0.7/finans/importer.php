<?php
// ----------finans/importer.php------------patch 2.0.7-----2009.03.19-----------
// LICENS
//
...
#		$kontonr=$_POST['kontonr'];
	...
	if (basename($_FILES['uploadedfile']['name'])) {
		...
		vis_data($kladde_id, $filnavn, '', $feltnavn, $feltantal, $bilag);
		}
		else{
	...
	elseif($submit=='Vis'){
		vis_data($kladde_id, $filnavn, $splitter, $feltnavn, $feltantal, $bilag);
	}
	elseif($submit=='Flyt'){
		if (($kladde_id)&&($filnavn)&&($splitter))	flyt_data($kladde_id, $filnavn, $splitter, $feltnavn, $feltantal, $bilag);
		else vis_data($kladde_id, $filnavn, $splitter, $feltnavn, $feltantal, $bilag);
	}
	else {
