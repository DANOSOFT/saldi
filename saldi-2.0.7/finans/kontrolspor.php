<?php
// ----------finans/kontrolspor.php-------------lap 2.0.7-----2009-05-14-----
// LICENS
//
...
print "<td align=center><span title= 'Angiv maksimale antal linjer, som skal vises pr. side'><input type=text size=3 style=\"text-align:right\" name=linjeantal value=$linjeantal></td>";
$tmp=$start+$linjeantal;
if ($next>0) {
