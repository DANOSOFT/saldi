...
//($bg==$bgcolor) ? $bg=$bgcolor5 : $bg=$bgcolor;
print "<div class=\"row\"><div class=\"left\">".findtekst('378|Mobile', $sprog_id)."<!--tekst 378--></div><div class=\"right\"><input class=\"text textIndent\" type=\"text\" name=\"mobile\" value=\"$mobile\" onchange=\"javascript:docChange = true;\"></div><div class=\"clear\"></div></div><!-- end of row -->\n";
