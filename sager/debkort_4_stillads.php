...
print "<div class=\"row\"><div class=\"left\">".findtekst('391|Bemærkning', $sprog_id)."<!--tekst 391--></div><div class=\"right\"><textarea name=\"notes\" rows=\"3\" cols=\"76\" style=\"min-width:681px;max-width:681px;\" class=\"textArea\">$notes</textarea></div><div class=\"clear\"></div></div><!-- end of row -->\n";
...
//print "<hr>\n";
	...
	if ($id) {
		...
		$ansat_id=$r['id'];
		if ($ansat_id) {
			print "<h3>".findtekst('392|Kontaktpersoner', $sprog_id)."<!--tekst 392--></h3>\n";
			print "<div class=\"contentkontakt\">\n";
			print "<ul><li>\n";
			//($bg==$bgcolor) ? $bg=$bgcolor5 : $bg=$bgcolor;
			print "<span class=\"pos\" title=\"".findtekst('393|Positionsnummer. Primær kontakt har nummer 1', $sprog_id)."\"><!--tekst 393--><b>".findtekst('394|Pos.', $sprog_id)."<!--tekst 394--></b></span>\n";
			print "<span class=\"kontakt\"><b>".findtekst('398|Kontakt', $sprog_id)."<!--tekst 398--></b></span>\n";
			print "<span class=\"lokal\" title=\"".findtekst('399|Direkte telefonnummer eller lokalnummer', $sprog_id)."\"><!--tekst 399--><b>".findtekst('400|Direkte/lokal', $sprog_id)."<!--tekst 400--></b></span>\n";
			print "<span class=\"mobil\"><b>".findtekst('401|Mobil', $sprog_id)."<!--tekst 401--></b></span>\n";
			print "<span class=\"email\"><b>".findtekst('402|E-mail', $sprog_id)."<!--tekst 402--></b></span>\n";
			...
			print "<h3>".findtekst('2928|Opret kontaktperson her', $sprog_id)."</h3>\n";
