...
if (findtekst('655|Lokal mobile', $sprog_id)) print "<div class=\"row\"><div class=\"left\">".findtekst('655|Lokal mobile', $sprog_id)."<!--tekst 655--></div><div class=\"right\"><input class=\"text textIndent\" type=\"text\" name=\"mobile\" value=\"$mobile\"></div><div class=\"clear\"></div></div><!-- end of row -->\n";
