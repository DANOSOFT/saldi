...
if ($menu == 'T') {
    ...
    print "<td width='10%' $top_bund><font face='Helvetica, Arial, sans-serif' color='#000066'><a href='betalingsliste.php' accesskey=L>Luk</a></td>";
...
print "<tr>";
print "<td colspan='2'><h3>Betalingsdato indstillinger</h3></td>";
print "</tr>";

print "<tr>";
print "<td width='30%'><b>Antal dage fra i dag:</b></td>";
print "<td><input type='number' name='paymentDays' value='$currentPaymentDays' min='0' max='365' style='width: 80px;'></td>";
print "</tr>";

print "<tr>";
print "<td><b>Forklaring:</b></td>";
print "<td>Angiv hvor mange dage fra i dag betalingsdatoen skal være som standard.</td>";
print "</tr>";

print "<tr>";
print "<td><b>Eksempel:</b></td>";
print "<td>I dag: <strong>$today</strong> → Betalingsdato: <strong>$exampleDate</strong></td>";
print "</tr>";
...
print "<tr>";
print "<td colspan='2'>";
print "<input type='submit' name='save' value='Gem indstillinger' style='background-color: #007bff; color: white; padding: 8px 16px; border: none; border-radius: 4px; cursor: pointer;'>";
print "&nbsp;&nbsp;";
print "<input type='button' value='Annuller' onclick=\"location.href='betalingsliste.php'\" style='background-color: #6c757d; color: white; padding: 8px 16px; border: none; border-radius: 4px; cursor: pointer;'>";
print "</td>";
print "</tr>";
