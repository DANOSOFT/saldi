...
if ($tmp=="Firmanavn") $tekst="Title=\"Tip: Tekster kan �ndres under Indstillinger -> Diverse -> Sprog -> Dansk!\"";
...
print "";
if ($ordre_id) {
	$tekst=findtekst('501|Opdatér feltet herunder med information fra ordren?.', $sprog_id);
...
print "<tr><td colspan=6>$a".findtekst('17|Bemærkning 1', $sprog_id)."$b<!--tekst 17--></td></tr>";
...
print "<tr><td colspan=6>".findtekst('24|Bemærkning 2', $sprog_id)."</td></tr>";
print "<tr><td colspan=6><textarea name=\"felt_indhold[8][1]\" rows=\"5\" cols=\"150\">".$felt_indhold[8][1]."</textarea></td></tr>\n";
print "<tr><td colspan=6><br></td></tr>";
print "<tr><td colspan=6>".findtekst('25|Bemærkning 3', $sprog_id)."</td></tr>";
