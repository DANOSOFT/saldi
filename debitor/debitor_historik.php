...
//
// --- debitor/debitor_historik.php -----patch 4.1.0 ----2025-04-15--------------
//                           LICENSE
//
...
// Handle POST for historik email sending
if (isset($_POST['historik']) && $_POST['debId']) {
	$debId=$_POST['debId'];
