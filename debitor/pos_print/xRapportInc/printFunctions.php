...
//
// ------------- debitor/pos_print/xRapportInc/printFunctions.php ---------- lap 3.7.4----2019.01.07-------
// LICENS
//
...
function printHeadline($fp, $firmanavn, $cvrnr, $orgNr, $date, $id, $type)
{
    if ($type == "xRapport") {
    ...
    $shopId = str_pad("Butik ID: $id", 45, ' ', STR_PAD_BOTH);
    fwrite($fp,"$shopId \n");
}
...
function printTurnover($fp, $omsatning) 
{
    ...
    printHeading($fp, "Dagens omsetning", $omsatning); 
}
...
function printBoxOpenings($fp, $drawArray)
{
    ...
    printTwoLiner($fp, $drawArray);
}


function printTwoLiner($fp, $dataArray)
{
    $whiteSpace = 44;
