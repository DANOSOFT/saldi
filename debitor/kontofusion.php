...
echo "select id from adresser where art='D' and kontonr='$kontonr' and id != '$id'<br>";
...
echo "$id&&$kontonr&&$fusion=='OK'<br>";
if ($id&&$kontonr&&$fusion=='OK') {
	transaktion('begin');
	$r=db_fetch_array(db_select("select min(id) as id from adresser where art='D' and lukket !='on' and kontonr='$kontonr' and id != '$id'",__FILE__ . " linje " . __LINE__));
