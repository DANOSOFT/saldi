...
#include "top.php";
	...
	elseif ($kodeord!=$kodeord2) {
		...
		if (strstr($_SERVER['PHP_SELF'],'gratis')) {
			...
			if ($pakke=='1') { 
				$posteringer = "max. 500 årlige";
				$pris = 45;
				$brugere = "og 1 bruger";
			}
			if ($pakke=='2') { 
				$posteringer = "max. 2500 årlige";
				$pris = 90;
				$brugere = "og 1 bruger";
			} 
			if ($pakke=='3') { 
				$posteringer = "max. 15000 årlige";
				$pris=180+($brugerantal*90);
				$tmp=$brugerantal+2;
				$brugere = "og $tmp samtidige brugere";
			} 
			if ($pakke=='4') { 
				$posteringer = "ubegrænset antal";
				$pris=270+($brugerantal*90);
				$tmp=$brugerantal+2;
				$brugere = ", $tmp samtidige brugere og 2 regnskaber";
			} 
				
#				$message .= "Bestilt: Saldi regnskab med max. 2500 årlige posteringer og 1 bruger, til kr 90,- pr. md\n";
#			if ($pakke=='3') $message .= "Bestilt: Saldi regnskab med max. 15000 årlige posteringer og 2 samtidige brugere til kr 180,- pr. md\n";
#			if ($pakke=='4') $message .= "Bestilt: Saldi regnskab med ubegrænset antal posteringer, 2 samtidige brugere og 2 regnskaber til kr 270,- pr. md\n";
			...
			if ($betaling ==1) $message .= "Fakturering : Hver måned.\n";
			if ($betaling ==2) $message .= "Fakturering : Hver 3. måned.\n";
			if ($betaling ==3) $message .= "Fakturering : Halvårlig.\n";
			if ($betaling ==4) $message .= "Fakturering : Årlig.\n";
		...
		$message .= "Ved første login oprettes 1. regnskabsår automatisk i indeværende år.\n";
		$message .= "Start og slut på 1 regnskabsår kan ændres under Indstillinger -> Regnskabsår. Klik på Id nr 1.\n";
		$message .= "Du finder dit regnskab på http://www.saldi.dk/finans \n\n";
...
#	        	print "<tr><td colspan=2><hr></td></tr>";
		...
		if ($pakke==3) $tekst=$tekst." med max. 15000 årlige posteringer og 2 samtidige brugere til kr 180,- pr. md.";
