...
--> 
 	 ...
 	 if (!isset($tilbud)) $tilbud=1;
			...
			print "<td><input type=RADIO name=\"tilbud\" value=\"1" \"$tilbud_1\"><span title=\"12 m&aring;neders abonnement med 4 timers kursus til kr. 1.500,-\">12 m&aring;neders abonnement med 4 timers kursus til kr. 1.500,-</span></td></tr>";
			print "<tr><td></td><td>";
			if ((isset($tilbud))&&($tilbud==2)) $tilbud_2="checked=\"checked\""; 
			print "<input type=RADIO  name="tilbud" value="2" <?php echo "$tilbud_2" ?>><span title=\"12 m&aring;neders abonnement til kr. 300,-\">12 m&aring;neders abonnement til kr. 300,-</span></td></tr>";
