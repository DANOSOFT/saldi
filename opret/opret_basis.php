...
//--></script>
	...
	<form action="opret_basis.php" onsubmit="return Form1_Validator(this)" method="POST" name="Form1">
...
#	        	print "<tr><td colspan=2><hr></td></tr>";
		...
		<tr><td>Accepterer <a onMouseOver="this.style.cursor = 'pointer'" onClick="javascript:betingelser=window.open('betingelser.html','betingelser','left=10,top=10,width=400,height=400,scrollbars=1,resizable=1');betingelser.focus();"><u>betingelser</u></a>
...
#cho "$regnskab $brugernavn $kodeord<br>";
