<!-- opret/aminotilbud.php * 2008-09-16 -->
...
#		print "<BODY onLoad=\"javascript:alert('De 2 kodeord skal være ens')\">";
    ...
    for ($i=0; $i<16; $i++) $kontrol_id .= $chars[rand(0, strlen($chars)-1)];
		...
		$message = "Tak for din bestilling af 12 måneders SALDI abonnement med 1 times \"kom i gang\" hjælp til kr. 540,-\n";
...
//--></script>
	...
	<form action="aminotilbud.php"  onsubmit="return Form1_Validator(this)" method="POST" name="Form1">
  	<TABLE BORDER="0"  CELLSPACING="0" align=center>
	<?php	
		$tekst="Udfyld formularen og klik på \"Opret regnskab\", for at bestille et års SALDI abonnement med 1 times kom i gang hjælp.<br>Der vil straks blive sendt en mail med et link til dit nye SALDI regnskab.<br>";
		?>
...
-->		<tr>	<td>Eventuelt</td>
		     	...
		     	<tr>	<td>Accepterer <a onMouseOver="this.style.cursor = 'pointer'" onClick="javascript:betingelser=window.open('aminobetingelser.htm','betingelser','left=10,top=10,width=400,height=400,scrollbars=1,resizable=1');betingelser.focus();"><u>betingelser</u></a></td>
			...
			tilbuddet&nbsp;er&nbsp;incl.&nbsp;500 årlige posteringer.<br>
