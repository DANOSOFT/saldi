...
<!DOCTYPE html>
  ...
  <td class="pad">
  <div style="color:#555555;font-family:'Oxygen', 'Trebuchet MS', Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
  <p style="margin: 0; word-break: break-word;"><strong>349 kr</strong></p>
  </div>
  </td>
  </tr>
  </table>
  ...
  <p style="margin: 0;"><a data-brz-link-type="external" style="text-decoration: underline; color: #0068A5;" href="#">her</a></p>
  </div>
  </td>
  </tr>
  </tbody></table>
  ...
  <p style="margin: 0;">Tilmeldingsoplysninger: <br>Navn: $navn <br>Firma: $firma <br>Cvr: $cvr</p>
