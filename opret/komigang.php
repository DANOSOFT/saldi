...
#		print "<BODY onLoad=\"javascript:alert('De 2 kodeord skal være ens')\">";
    ...
    for ($i=0; $i<16; $i++) $kontrol_id .= $chars[rand(0, strlen($chars)-1)];
		...
		if ($tilbud==1) $message=$message." 12 måneders SALDI abonnement med aftenkursus til kr. 1.150,-\n";
		if ($tilbud==2) $message=$message." 12 måneders SALDI abonnement med personligt kursus til kr. 1.500,-\n";
		if ($tilbud==3) $message=$message." 12 måneders SALDI abonnement til kr. 300,-\n";
		if ($tilbud==4) $message=$message." 6 måneders SALDI abonnement med 4 aftenkursus til kr. 950,-\n";
		if ($tilbud==5) $message=$message." 6 måneders SALDI abonnement til kr. 200,-\n";
		...
		$message .= "Som SALDI kunde har du adgang til hotline og e-mail support. Benyt mailadressen support@saldi.dk.\n";
		...
		$mail->Subject  =  "Bestilling af SALDI kom i gang tilbud";
		$mail->Body     =  $message;
...
//--></script>
	...
	<form action="komigang.php"  onsubmit="return Form1_Validator(this)" method="POST" name="Form1">
...
--> 
 	 ...
 	 if (!isset($tilbud)) $tilbud=1;
			...
			?>
			<td><input type=RADIO name="tilbud" value="1" <?php echo "$tilbud_1" ?>><span title="12 m&aring;neders abonnement med 4 timers kursus til kr. 1.500,-">12 m&aring;neders abonnement med aftenkursus til kr. 1.150,-</span></td></tr>
			<tr><td></td><td><?php if ((isset($tilbud))&&($tilbud==2)) $tilbud_2="checked=\"checked\""; ?><input type=RADIO  name="tilbud" value="2" <?php echo "$tilbud_2" ?>><span title="12 m&aring;neders abonnement med 4 timers personligt kursus til kr. 300,-"><span title="12 m&aring;neders abonnement til kr. 300,-">12 m&aring;neders abonnement og personligt kursus til kr. 1.500,-</span></td></tr>
			<tr><td></td><td><?php if ((isset($tilbud))&&($tilbud==3)) $tilbud_2="checked=\"checked\""; ?><input type=RADIO  name="tilbud" value="3" <?php echo "$tilbud_3" ?>><span title="12 m&aring;neders abonnement til kr. 300,-"><span title="12 m&aring;neders abonnement til kr. 300,-">12 m&aring;neders abonnement til kr. 300,-</span></td></tr>
			<tr><td></td><td><?php if ((isset($tilbud))&&($tilbud==4)) $tilbud_3="checked=\"checked\""; ?><input type=RADIO  name="tilbud" value="4" <?php echo "$tilbud_4" ?>><span title="6 m&aring;neders abonnement med aftenkursus til kr. 950,-">6 m&aring;neders abonnement med 4 timers kursus til kr. 950,-</span></td></tr>
				</td>
			</tr><tr><td></td></tr>
		<tr>	<td>Eventuelt</td>
		     	<td><textarea name="eventuelt" rows="2" wrap="Virtual" cols="45"><?php echo "$eventuelt" ?></textarea></td>
		</tr><tr><td></td></tr>
...
?>	
		<top>
		<center>
		<table valign=top border=1><tbody><tr><td colspan=2><img alt="Saldi logo" src="logo.png" style="border: 0px solid ;"></td></tr>
