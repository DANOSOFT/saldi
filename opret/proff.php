...
# Priser
$prisprbruger=30; # Pr. samtidig bruger pr. md
$prispr1000posteringer=30; # Pr. 1000 posteringer pr. md
$faktureringsgebyr=12;
$prisaftenkursus=850;
$rabatprisaftenkursus=200;
$priskomigang=1600;
...
print "<tr><td colspan=2><b><big>$tekst</big></b></td>
	...
	$spantekst="V&aelig;lg hvor ofte du vil modtage faktura.<br>Der till&aelig;gges kr. ".$faktureringsgebyr.",- i faktureringsgebyr p&aring; hver faktura."; 
