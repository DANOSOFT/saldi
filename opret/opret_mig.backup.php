...
<html>
<head><meta content="text/html; charset=ISO-8859-1" http-equiv="content-type"><title>Oprettelsesformular</title></head>
<body style="background-image: url(blaa2hvid.gif);">
...
//--></script>
	...
	<form action="opret_mig.php?returadresse=<?php echo $returadresse ?>"  onsubmit="return Form1_Validator(this)" method="POST" name="Form1">
  	<TABLE BORDER="0"  CELLSPACING="0" align=center>
		...
		<tr>	<td width="100"><font size="2" face="Arial">Navn *</font></td>
          		<td><input type=text name=navn size="50" value="<?php echo "$navn" ?>"></td>
        	</tr><tr><td></td></tr>
        	<tr>	<td><font size=2 face="Arial">Firma / Forening</font></td>
		     	<td><input type=text name=firma size="50" value="<?php echo "$firma" ?>"></td>
        	</tr><tr><td></td></tr>
		<tr>	<td><font size=2 face="Arial">Evt. CVR nr.</font></td>
		     	<td><input type=text name=cvr size="50" value="<?php echo "$cvr" ?>"></td>
		</tr><tr><td></td></tr>
		<tr>	<td><font size=2 face="Arial">Adresse *</font></td>
		     	<td><input type=text name=adresse size="50" value="<?php echo "$adresse" ?>"></td>
		     	</tr><tr>	     
		     	<td></td><td><input type=text name=adresse2 size="50" value="<?php echo "$adresse2" ?>"></td>
		</tr><tr><td></td></tr>
	    	 	<tr>	<td> <font size=2 face="Arial">Postnr & By *</font></td>
		     	<td><input type=text name=postnr size="4" value="<?php echo "$postnr" ?>"><input type=text name=bynavn size="44" value="<?php echo "$bynavn" ?>"></td>
		</tr><tr><td></td></tr>
			<tr>	<td><font size=2 face="Arial">Telefon</font></td>
		     	<td><input type=text name=telefon size="50" value="<?php echo "$telefon" ?>"></td>
		</tr><tr><td></td></tr>
		<tr>	<td> <font size=2 face="Arial">E-mail *</font></td>
		     	<td><input type=text name=email size="50" value="<?php echo "$email" ?>"></td>
		</tr><tr><td></td></tr>
		<tr><td><font size=2 face="Arial">&Oslash;nsket navn p&aring; regnskab *</font></td>
		     	<td><input type=text name=regnskab size="50" value="<?php echo "$regnskab" ?>"></td>
		</tr><tr><td></td></tr>
		<tr><td><font size=2 face="Arial">&Oslash;nsket&nbsp;brugernavn&nbsp;for&nbsp;administrator&nbsp;*</font></td>
		     	<td><input type=text name=brugernavn size="50" value="<?php echo "$brugernavn" ?>"></td>
		</tr><tr><td></td></tr>
		<tr><td><font size=2 face="Arial">&Oslash;nsket&nbsp;kodeord&nbsp;for&nbsp;administrator&nbsp;*</font></td>
		     	<td><input type=password name=kodeord size="50" value="<?php echo "$kodeord" ?>"></td>
		</tr><tr><td></td></tr>
		<tr><td><font size=2 face="Arial">Gentag&nbsp;&oslash;nsket&nbsp;kodeord&nbsp;for&nbsp;administrator&nbsp;*</font></td>
		     	<td><input type=password name=kodeord2 size="50" value="<?php echo "$kodeord2" ?>"></td>
 <?php if (!strstr($_SERVER['PHP_SELF'],'gratis')) { ?>
			</tr><tr><td></td></tr>
			 <tr><td> <font size=2 face="Arial">&Oslash;nsket antal samtidige <a onMouseOver="this.style.cursor = 'pointer'" onClick="javascript:brugere=window.open('brugere.html','brugere','left=10,top=10,width=400,height=400,scrollbars=1,resizable=1');brugere.focus();"><font color=blue><u>brugere</u></font></font></a></td>
			     	<td><input type=text name=brugerantal size="2"  value="<?php echo "$brugerantal" ?>"value=2></td>
		    	</tr><tr><td></td></tr>
		    	</tr><tr><td></td></tr>
        		<tr>	<td><font size=2 face="Arial">"Kom igang pakke"</font></td>
			...
			?>
			<td><font size=2 face="Arial"><span title="Prøveperiode 6 mdr. til kr. 450,- excl. moms.">pakke 1&nbsp;<input type=RADIO name="pakke" value="1" <?php echo "$pakke_1" ?>></span>
			...
			&nbsp;&nbsp;&nbsp;pakke 5&nbsp;<input type=RADIO  name="pakke" value="5" <?php echo "$pakke_5" ?>><span></font>
			</td>
			</tr><tr><td></td></tr>
<?php } ?>		
		<tr>	<td><font size=2 face="Arial">Eventuelt</font></td>
		     	<td><textarea name="eventuelt" rows="3" wrap="Virtual" cols="45"><?php echo "$eventuelt" ?></textarea></td>
		</tr><tr><td></td></tr>
		     	<tr>	<td><font size=2 face="Arial">Accepterer <a onMouseOver="this.style.cursor = 'pointer'" onClick="javascript:betingelser=window.open('betingelser.html','betingelser','left=10,top=10,width=400,height=400,scrollbars=1,resizable=1');betingelser.focus();"><font color=blue><u>betingelser</u></font></a></font></td>
        	...
        	<td><input type=CHECKBOX name="betingelser" <?php echo "$betingelser" ?>></td>
			 ...
			 <td style="text-align: center;" colspan="2"><input value="Opret regnskab" name="SUBMIT" type="submit"><br>
			<font face="Arial" size="1">Udfyld&nbsp;venligst&nbsp;s&aring;&nbsp;meget&nbsp;som&nbsp;muligt</font><br>
			<font face="Arial" size="1">Felter&nbsp;markeret&nbsp;med&nbsp;*&nbsp;skal&nbsp;udfyldes</font><br>
			<font face="Arial" size="1">Du&nbsp;modtager&nbsp;en&nbsp;E-mail&nbsp;med&nbsp;et&nbsp;link&nbsp;til&nbsp;dit&nbsp;nye&nbsp;regnskab</font></td>
 	</tr>
	</TABLE>
	</form>
<?php
