...
Element: draw:custom-shape [ Mobile: $egen_mobile ] Attr: [draw:layer: Saldi-Objekter] [svg:width: 5.876cm] [svg:height: 0.5cm] [svg:x: 14.544cm] [svg:y: 5.874cm] [draw:style-name: gr3] [draw:text-style-name: P2]
