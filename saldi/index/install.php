...
#	rename("../includes/connect", "../includes/connect.php");
	...
	if ($fp=fopen("../includes/connect.php","w") ) {
		...
		print "<p>Srg for at der er skriveadgang for den bruger, som den besgende krer som. til katalogerne \n";
	...
	<tr><td align="center" valign="bottom">
		<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"><tbody>
			<td width="25%" bgcolor=#bbbbbb><font face="Helvetica, Arial, sans-serif"><small>Copyright (C) 2004-2005 DANOSOFT ApS</small></td>
...
function skriv_connect($fp, $host, $db_bruger, $db_password, $db_navn) {
	fwrite($fp," \n");
		fwrite($fp,"<?php\n");
		fwrite($fp,"// ------------------------------------------------------/includes/connect.php---------------lap 1.0.2----------\n");
		fwrite($fp,"// LICENS\n");
		fwrite($fp,"//\n");
		...
		fwrite($fp,"//\n");
		fwrite($fp,"// Copyright (c) 2004-2006 DANOSOFT ApS\n");
		fwrite($fp,"// ----------------------------------------------------------------------\n");
		fwrite($fp,"\n");
