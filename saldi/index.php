...
<noscript>
	<body>
		...
		<p>
		Fra Saldi-projektets ledelse vil vi anbefale 
		<a href="http://www.mozilla.com/firefox/">Mozilla Firefox</a>, 
		som findes til de fleste styresystemer og kan 
		frit hentes fra internettet via henvisningen.
		</p>
</noscript>
	
<body onload="javascript:window.open('index/index.php', '', ',statusbar=0,menubar=0,titlebar=0,toolbar=0,scrollbars=1');">
	
<script type="text/javascript"><!--
	
document.write("<h1>Velkommen til Saldi</h1>");
...
document.write("&Aring;rsagen kan være, at din maskine ikke har adgang til internettet.");
document.write("</p>");

saldi_version = "1.0.6";
saldi_hovedversion = "1.0";

// Frigivelsesdato og -time. Angives som ÅÅÅÅMMDDTT - Kan muligvis give problemer efter &aring;r 2147.
saldi_frigivet = "2006101915"; 
saldi_besked_farve = "#ccc";

//--></script>

<script type="text/javascript" src="http://projekt.saldi.dk/js/opdateringskontrol/saldi_1_0_6.js" ></script>
...
<p style="text-align:center">&copy; <a href="http://www.itz.dk/">ITz ApS</a></p>
</body>
</html>
