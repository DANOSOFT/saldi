...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"><tbody>
	<tr><td align="center" valign="top">
		<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"><tbody>
			<td width="25%" bgcolor="<?php echo $bgcolor2 ?>"><font face="Helvetica, Arial, sans-serif" color="#000066"><small><a href=../index/index.php accesskey=T>Tilbage</a></small></td>
			<td width="50%" bgcolor="<?php echo $bgcolor2 ?>" align="center"><font face="Helvetica, Arial, sans-serif" color="#000066"><small>Opret regnskab</small></td>
			<td width="25%" bgcolor="<?php echo $bgcolor2 ?>" align = "right"><font face="Helvetica, Arial, sans-serif" color="#000066"><small><br></small></td>
		</tbody></table>
	</td></tr>
...
function opret ($sqhost, $squser ,$sqpass, $db, $admin, $passwd, $std_kto_plan)
{
	...
	db_modify("CREATE TABLE adresser (id serial NOT NULL, firmanavn varchar, addr1 varchar, addr2 varchar, postnr varchar, bynavn varchar, land varchar, kontakt varchar, tlf varchar, fax varchar, email varchar, web varchar, bank_navn varchar, bank_reg varchar, bank_konto varchar, notes varchar, rabat numeric, momskonto integer, kreditmax numeric, betalingsbet varchar, betalingsdage integer DEFAULT 0, kontonr varchar, cvrnr varchar, ean varchar, institution varchar, art varchar, gruppe integer, kontoansvarlig integer, PRIMARY KEY (id))");
	db_modify("CREATE TABLE ansatte (id serial NOT NULL, konto_id integer, navn varchar, addr1 varchar, addr2 varchar, postnr varchar, bynavn varchar, tlf varchar, fax varchar, mobil varchar, privattlf varchar, initialer varchar, email varchar, notes varchar, cprnr varchar, posnr integer, afd integer, provision numeric, PRIMARY KEY (id))");
	...
	db_modify("CREATE TABLE openpost (id serial NOT NULL, konto_id integer, konto_nr varchar, faktnr varchar, amount numeric, refnr integer, beskrivelse varchar, udlignet varchar, transdate date, kladde_id integer, udlign_id integer, udlign_date date, PRIMARY KEY (id))");
...
#	 include("../includes/kontoplan.php"); 
		...
		db_modify("insert into grupper (beskrivelse, kode, kodenr, art, box1, box2) values ('Kbsmoms 25%', 'K', '1', 'KM', '33200', '25')");
		db_modify("insert into grupper (beskrivelse, kode, kodenr, art, box1, box2, box3) values ('Erhvervelsesmoms 25%', 'E', '1', 'EM', '33300', '25', '33200')");
		db_modify("insert into grupper (beskrivelse, kode, kodenr, art, box1, box2) values ('Danske Debitorer', 'D', '1', 'DG', 'S1', '25100')");
		db_modify("insert into grupper (beskrivelse, kode, kodenr, art, box1, box2) values ('Danske Kreditorer', 'K', '1', 'KG', 'K1', '34100')");
