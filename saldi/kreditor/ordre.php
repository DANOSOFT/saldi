					 ...
					 if ($tidl_lev[$x]<$antal[$x]){$status=1;}
						...
						elseif ($antal[$x]-$tidl_lev[$x]!=$row[antal]) {
							if (($antal[$x]>=0)&&($tidl_lev[$x]<0)) {
								print "<BODY onLoad=\"javascript:alert('Antal m&aring; ikke &aelig;ndres til positivt tal når der er returneret varer (Pos nr. $posnr[$x])')\">";
								$antal[$x]=$tidl_lev[$x];
							}
