<?php
// -----------------------------------------------finans/kontrolspor.php-------------lap 1.0.2----------
// LICENS
//
...
print "<td width=50% bgcolor=$bgcolor2 align=center>$font<small>Kontrolspor</small></td>";
...
print "<td align=center><span title= 'Angiv max antal linjer som skal vises pr side'><input type=text size=3 name=linjeantal value=$linjeantal  align=right></td>";
$tmp=$start+$linjeantal;
if ($next>0) {
...
print "<td align=center><small><b>$font<a href='kontrolspor.php?nysort=logdate&sort=$sort&valg=$valg$hreftext'>Log. dato</a></b></small></td>";
print "<td align=center><small><b>$font tidspkt</a></b></small></td>";
...
print "<tr>";
print "<td align=right><span title= 'Angiv et id nummer eller angiv to adskilt af kolon (f.eks 345:350)'><input type=text size=3 name=idnumre value=$idnumre></td>";
print "<td align=right><span title= 'Angiv en dato eller angiv to adskilt af kolon (f.eks 010605:300605)'><input type=text size=8 name=transdatoer value=$transdatoer></td>";
print "<td align=right><span title= 'Angiv en dato eller angiv to adskilt af kolon (f.eks 010605:300605)'><input type=text size=8 name=logdatoer value=$logdatoer></td>";
print "<td align=right><span title= 'Angiv et tidspunkt  (f.eks 17:35)'><input type=text size=3 name=logtid value=$logtid></td>";
print "<td align=right><span title= 'Angiv et kassekladdenummer eller angiv to adskilt af kolon (f.eks 345:350)'><input type=text size=3 name=kladdenumre value=$kladdenumre></td>";
print "<td align=right><span title= 'Angiv et bilagsnummer eller angiv to adskilt af kolon (f.eks 345:350)'><input type=text size=5 name=bilagsnumre value=$bilagsnumre></td>";
print "<td align=right><span title= 'Angiv et kontonummer eller angiv to adskilt af kolon (f.eks 345:350)'><input type=text size=3 name=kontonumre value=$kontonumre></td>";
print "<td align=right><span title= 'Angiv et fakturanummer eller angiv to adskilt af kolon (f.eks 345:350)'><input type=text size=5 name=fakturanumre value=$fakturanumre></td>";
print "<td align=right><span title= 'Angiv et bel&oslash;b eller angiv to adskilt af kolon (f.eks 10000,00:14999,99)'><input type=text size=8 name=debetbelob value=$debetbelob></td>";
print "<td align=right><span title= 'Angiv et bel&oslash;b eller angiv to adskilt af kolon (f.eks 10000,00:14999,99)'><input type=text size=8 name=kreditbelob value=$kreditbelob></td>";
