...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"><tbody>
	<tr><td height = "25" align="center" valign="top">
		<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"><tbody>
			<td width="25%" bgcolor="<?php echo $bgcolor2 ?>"><font face="Helvetica, Arial, sans-serif"><small><a href=../includes/luk.php accesskey=T>Tilbage</a></small></td>
			<td width="50%" bgcolor="<?php echo $bgcolor2 ?>" align="center"><font face="Helvetica, Arial, sans-serif"><small>Debitorliste</small></td>
			<td width="25%" bgcolor="<?php echo $bgcolor2 ?>" align="right"><font face="Helvetica, Arial, sans-serif"><small><a href=debitorkort.php accesskey=N>Ny</a></small></td>
			 </tr>
			</tbody></table>
	</td></tr>
 <tr><td valign="top">
