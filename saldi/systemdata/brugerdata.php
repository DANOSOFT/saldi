<?php
// -------------------------------------------------systemdata/brugerdata.php ------lan 1.0.8---------------
// LICENS
//
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"><tbody>
	<tr><td align="center" valign="top">
		<table width="100%" align="center" border="1" cellspacing="0" cellpadding="0"><tbody><td>
			...
			<td width="25%" bgcolor="<?php echo $bgcolor2 ?>"><font face="Helvetica, Arial, sans-serif" color="#000066"><small><a href=../index/menu.php accesskey=T>Tilbage</a></small></td>
			<td width="50%" bgcolor="<?php echo $bgcolor2 ?>" align="center"><font face="Helvetica, Arial, sans-serif" color="#000066"><small>Brugerindstillinger for <?php print $brugernavn." | ".$regnskab ?></small></td>
