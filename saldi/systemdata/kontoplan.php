<?php
// -------------------------------------systemdata/kontoplan.php--------------------------------lap 1.0.5----------
// LICENS
//
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"><tbody>
	<tr><td height = "25" align="center" valign="top">
		<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"><tbody>
			<td width="25%" bgcolor="<?php echo $bgcolor2 ?>" align="left"><font face="Helvetica, Arial, sans-serif"><small><a href=../includes/luk.php accesskey=T>Tilbage</a></small></td>
			<td width="50%" bgcolor="<?php echo $bgcolor2 ?>" align="center"><font face="Helvetica, Arial, sans-serif" color="#000066"><small>Kontoplan</small></td>
			<td width="25%" bgcolor="<?php echo $bgcolor2 ?>" align="right"><font face="Helvetica, Arial, sans-serif" color="#000066"><small><a href=kontokort.php accesskey=N>Ny</a></small></td>
			</tbody></table>
	</td></tr>
 <tr><td valign="top">
...
<tbody>
	<tr>
		<td><b><font face="Helvetica, Arial, sans-serif" color="<?php echo $bgcolor2 ?>">Kontonr</b></td>
		<td><b><font face="Helvetica, Arial, sans-serif" color="<?php echo $bgcolor2 ?>">Beskrivelse</a></b></td>
		<td><b><font face="Helvetica, Arial, sans-serif" color="<?php echo $bgcolor2 ?>">Type</a></b></td>
		<td><b><font face="Helvetica, Arial, sans-serif" color="<?php echo $bgcolor2 ?>">Moms</a></b></td>
		<td><b><font face="Helvetica, Arial, sans-serif" color="<?php echo $bgcolor2 ?>">Genvej</a></b></td>
