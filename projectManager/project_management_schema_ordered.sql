-- Project Management System Database Schema - Step by Step Installation
-- For issue tracking, agile project management, and collaboration
-- Compatible with existing 'brugere' table
-- PostgreSQL version - Ordered for proper installation

-- Phase 1: Create basic lookup tables first
-- Issue/Task types
...
-- Phase 2: Insert default data for lookup tables
...
-- Phase 3: Create main entity tables
-- Projects table
...
-- Issue statuses (project-specific)
...
-- Phase 5: Create indexes for better performance
