...
// ------------/admin/opret.php-----patch 3.4.2------ 2014-05-08 --------
// LICENS
//
...
#	$tmp=db_escape_string($regnskab);
	...
	if ($row = db_fetch_array($query)) {
		...
		db_modify("insert into regnskab (regnskab,dbhost,dbuser,brugerantal,posteringer,email) values ('$regnskab','$sqhost','$squser','$brugerantal','$posteringer','$email')",__FILE__ . " linje " . __LINE__);
