<?php
// -----------------finans/hentordrer.php------------lap 2.0.0b-------28.04.2008----------
// LICENS
//
...
#				$moms[$x]=$sum[$x]/100*$row[box2]; #moms af varekb i udlander beregnes
				...
				if ($moms[$x]>0) {
					print "<tr><td>$font<small>$fakturadato[$x]<br></small></td><td>$font<small>$firmanavn[$x]<br></small></td><td>$font<small><br></small></td><td>$font<small><br></small></td><td>$font<small>F<br></small></td><td>$font<small>$row[box1]<br></small></td><td>$font<small>$fakturanr[$x]<br></small></td><td align=right>$font<small>$tmp<br></small></td><td align=right>$font<small>$valuta[$x]<br></small></td></tr>";
				} else {
					print "<tr><td>$font<small>$fakturadato[$x]<br></small></td><td>$font<small>$firmanavn[$x]<br></small></td><td>$font<small>F<br></small></td><td>$font<small>$row[box1]<br></small></td><td>$font<small><br></small></td><td>$font<small><br></small></td><td>$font<small>$fakturanr[$x]<br></small></td><td align=right>$font<small>$tmp<br></small></td><td align=right>$font<small>$valuta[$x]<br></small></td></tr>";
				}
			}
			else {
