<?php
// ----------finans/kontrolspor.php-------------lap 2.0.0b-----28.04.2008-----
// LICENS
//
...
function udskriv($idnumre, $bilagsnumre, $kladdenumre, $fakturanumre, $kontonumre, $transdatoer, $logdatoer, $debetbelob, $kreditbelob, $logtid, $beskrivelse, $sort, $start, $skriv) {
	...
	if ($debetsum || $kreditsum) {
		...
		print "<td colspan=8><small>Kontrolsum<br></small></td><td align=right>$font<small>".dkdecimal($debetsum)."<br></small></td><td align=right>$font<small>".dkdecimal($kreditsum)."<br></small></td><td><small><br></small></td></tr>";
	}
#	print "<tr><td colspan=11><hr></td></tr>";
	return ($y);
} #endfunction udskriv()
