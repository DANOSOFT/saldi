...
//                  hentes med findtekst(5400) - se nye raekker 5400-5451 i
...
#	print"<td $td $stor_knap_bg><a onfocus=\"this.style.color='$bgcolor2'\" onblur=\"this.style.color='#000066'\" href=\"../admin/stdkontoplan.php\"><br></td>";
	...
	print"</tr><tr>";
	print"<td $td $stor_knap_bg><a onfocus=\"this.style.color='$bgcolor2'\" onblur=\"this.style.color='#000066'\" href=\"../admin/opret_email.php\"><big>".findtekst(5400, $sprog_id)."</big></a></td>"; #Opret email
