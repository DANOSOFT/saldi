...
// Ensure style variables are accessible when included from within a function
global $buttonStyle, $topStyle, $butDownStyle, $buttonColor, $buttonTxtColor;
global $source, $sourceId, $kladde_id, $fokus, $sprog_id, $bgcolor;
...
// Header row - matching topLineKassekladde.php structure  
...
# Middle section with Documents button - nested table like kassekladde
...
print "<td width='200px' align=center id='documents-btn'>
	...
	$icon_documents ".findtekst('1408|Kassebilag', $sprog_id)."
	</button></td>";
