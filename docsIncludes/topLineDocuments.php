...
print "<div class='docs-sticky-header'>";
...
print "<td width='90%' style='$topStyle' align='left'><table border='0' cellspacing='2' cellpadding='0'><tbody><tr>\n";
...
<style>
	...
	.docs-content-wrapper {
		margin-top: 50px; /* Space for sticky header */
	}
