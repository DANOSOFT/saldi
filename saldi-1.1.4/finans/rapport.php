...
// --------------------------------------------finans/rapport.php--------------lap 1.1.4---20070730-------
// LICENS
//
...
if ($_POST['submit']){
	...
	$aar_fra=$_POST['aar_fra'];
	$aar_til=$_POST['aar_til'];
	...
	$ansat_init=$_POST['ansat_init'];
	$antal_ansatte=$_POST['antal_ansatte'];
	list ($tmp, $tmp2) = split(":", $_POST['ansat']);
	...
	list ($afd, $afd_navn) = split(":", $_POST['afd']);
	$afd=trim($afd);
	list ($projekt, $prj_navn) = split(":", $_POST['projekt']);
...
#	print "</tbody></table>"; #B slut
	...
	print "</tr><td>$font<small>Rapport art</, $afdtd><td><select name=rapportart>\n";
	...
	if ($antal_ansatte) {
		print "<tr><td>$font<small>Ansatte</td><td><select name=ansat>\n";
...
#	print "$font <a accesskey=L href=\"rapport.php?rapportart=Kontokort&regnaar=$regnaar&dato_fra=$startdato&maaned_fra=$mf&dato_til=$slutdato&maaned_til=$mt&konto_fra=$konto_fra&konto_til=$konto_til&afd=$afd\">Luk</a><br><br>";
	...
	print "<td><small>$font $startdato $mf - $slutdato $mt</span></small></td></tr>";
...
#	if ($slutmaaned<10){$slutmaaned="0".$slutmaaned;}
 ...
 #	print "$font <a accesskey=L href=\"rapport.php?rapportart=$rapportart&regnaar=$regnaar&dato_fra=$startdato&maaned_fra=$mf&dato_til=$slutdato&maaned_til=$mt&konto_fra=$konto_fra&konto_til=$konto_til&afd=$afd\">Luk</a><br><br>";
	...
	print "<tr><td colspan=\"6\" height=\"8\">";
	print "<table width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"3\" cellpadding=\"0\"><tbody>"; #B
	print "<td width=\"10%\" $top_bund><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\"><small><a accesskey=L href=\"rapport.php?rapportart=$rapportart&regnaar=$regnaar&dato_fra=$startdato&maaned_fra=$mf&aar_fra=$aar_fra&dato_til=$slutdato&maaned_til=$mtf&aar_til=$aar_til&konto_fra=$konto_fra&konto_til=$konto_til&ansat=$ansat&afd=$afd&projekt=$projekt\">Luk</a></small></td>";
