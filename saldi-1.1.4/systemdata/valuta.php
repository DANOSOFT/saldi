<?php
// -------------systemdata/valuta.php----lap 1.1.4-------18.12.07-----------
// LICENS
//
...
<tbody>
	...
	<?php
$x=0;
$query = db_select("select * from grupper where art = 'VK' order by box1");
while ($row = db_fetch_array($query)) {
	...
	$kurs=dkdecimal($row['box2']);
	print "<td><a href=valutakort.php?kodenr=$row[kodenr]&valuta=$row[box1]>$font $row[box1]</a><br></small></td>";
