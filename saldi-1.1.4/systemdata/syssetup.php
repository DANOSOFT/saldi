<?php
// -----------------systemdata/syssetup.php----lap 1.1.4---12.12.07---
// LICENS
//
...
elseif($valg=='debitor'){
	...
	print "<tr><td></td><td>$font<small>Nr</td><td align=center>$font<small>Beskrivelse</td><td align=center>$font<small>Momsgrp</td>";
	print "<td align=center>$font<small>Samlekt.</td><td align=center>$font<small>Valuta</td>";
...
global $valg;
	...
	for ($i=0; $i<=$x; $i++) {
		...
		if ($art[$i]=='DG' && isset($box7[$i])) {
			$box6[$i]=dkdecimal($box6[$i]);
		}
