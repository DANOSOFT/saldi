<?php
// -------------debitor/ordreliste.php-------lap 1.1.4----04.02.2008------
// LICENS
//
...
if ($valg=='faktura') {
	...
	print "<td title='Dato for genfakturerering ved f.eks. abonnementskunder'><small><b>$font<a href='ordreliste.php?nysort=nextdate&sort=$sort&valg=$valg$hreftext'>Genfakt</b></small></td>";
}
