...
print "</td></tr><tr><td align=center colspan=3><table cellpadding=0 cellspacing=0 border=1 width=100%><tbody>";
	...
	print "<td align=center>$font<small><b>dato</td><td align=center>$font<small><b>faktura</td><td align=center>$font<small><b>beskrivelse</td><td align=center>$font<small><b>pris</td>";
	print "</tr>\n";
	$x=0;
	$sum=0;
