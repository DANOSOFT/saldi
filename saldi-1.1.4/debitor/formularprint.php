...
// ---------debitor/formularprint-----patch 1.1.3----03.02.2008------
// LICENS
//
...
$x=0;
echo "select * from formularer where formular = $formular and art = 1 and beskrivelse = 'LOGO' and lower(sprog)='$sprog'<br>";
