...
if (isset($_POST) && $_POST) {
	...
	db_modify("update grupper set box2='$vis_VG', box3='$vis_K', box4='$vis_lukkede' where art = 'VV' and box1 = '$brugernavn'");
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"><tbody>
	<tr><td height = "25" align="center" valign="top">
		<table width="100%" align="center" border="0" cellspacing="2" cellpadding="0"><tbody>
			...
			<td width="80%"<?php echo $top_bund ?>><font face="Helvetica, Arial, sans-serif"><small>Varevisning</a></small></td>
...
if ($r = db_fetch_array(db_select("select * from grupper where art = 'VV' and box1 = '$brugernavn'"))) {
	...
	db_modify("insert into grupper(beskrivelse, art, box1)values('varevisning', 'VV', '$brugernavn')");
	$vis_VG[0]='on';
	$vis_K[0]='on';
}
...
$q = db_select("select * from grupper where art = 'VG' order by beskrivelse");
