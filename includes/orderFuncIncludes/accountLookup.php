...
HTML;
    ...
    // Determine most common payment terms
    $pMax = $x = 0;
    $pterms = array();
    $pcount = array();
    $defaultPterm = '';
    ...
    print "<tr><td style='padding:4px 8px;'></td><td style='padding:4px 8px;'><input style='width:150px;' type='text' name='kontonr' value='$kontonr_safe'></td></tr>";
    ...
    print "<tr><td style='padding:4px 8px;'></td><td style='padding:4px 8px;'></td></tr>";
