...
//                prevent truncation. Uses new tekst 5056 (not 3360) so the
...
#	$butStyle.= "color:white;background-color:$butCol";
		...
		print "<td align=center><input style=\"$butStyle\" type='submit' value='$tekst1' name='kontokort' title='$tekst2'></td></tr>";
			...
			if ($r && ($r['var_value'] == 'on')) {
				...
				print "<td align=center><span onClick=\"javascript:location.href='../debitor/salg_postnr.php'\"><input title='".findtekst('3360|Salg pr. postnummer', $sprog_id)."' style=\"$butStyle\" type='button' value='".findtekst('5056|Salg pr. Postnr', $sprog_id)."'></span></td>\n";
