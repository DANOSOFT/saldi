<?php
// --------------------------------------------- includes/opdater.php-------lap 1.1.0 --------------------
// LICENS
//
...
function opdat_0($version, $dbver){
	...
	if (!$backup) {
		...
		print "<tr><td align=center><a href=../includes/opdater.php?version=$version&dbver=$dbver&backup=OK accesskey=F>$font Forts&aelig;t</a><br></td></tr>";
