<?php
// -------------------debitor/prislister.php------------patch 3.1.5----2011-03-14--------------
// LICENS
//
...
#			$antal_salgssenh[$x]=substr($linje,36,5);
			$salgspris[$x]=substr($linje,38,12); #41,8
...
$href = "../includes/luk.php?returside=debitor/ordre.php&id=$ordre_id&fokus=$fokus";
