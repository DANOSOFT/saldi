...
($bg == $bgcolor) ? $bg = $bgcolor5 : $bg = $bgcolor;
print "<tr bgcolor=$bg><td> " . findtekst('378|Mobil', $sprog_id) . "</td><td><input class=\"inputbox\" type=text size=\"10\" name=mobile value=\"$mobile\" onchange=\"javascript:docChange = true;\"></td></tr>\n";
($bg == $bgcolor) ? $bg = $bgcolor5 : $bg = $bgcolor;
