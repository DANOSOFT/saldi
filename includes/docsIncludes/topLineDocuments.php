...
$border = 'border:1px';
if (isset($bgcolor)) $TableBG = "bgcolor=$bgcolor";
...
// Simple header row output - just the TR content
print "<tr>";
...
// Middle - Document pool title
print "<td width='85%' style='$topStyle' align='left'>
	<button class='headerbtn navbtn-top' style='$butDownStyle' onMouseOver=\"this.style.cursor='pointer'\">
	$icon_documents ".findtekst('2592|Dokumentpulje', $sprog_id)."
	</button></td>";

// Help button
print "<td id='tutorial-help' width='5%' style='$buttonStyle'>
	<button class='center-btn' style='$buttonStyle; width:100%' onMouseOver=\"this.style.cursor='pointer'\">
	$help_icon ".findtekst('2564|Hjælp', $sprog_id)."</button></td>";
