...
export default class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://virtserver.swaggerhub.com/saldi-dc1/swagger/1.0.0
         */
        this.basePath = 'https://virtserver.swaggerhub.com/saldi-dc1/swagger/1.0.0'.replace(/\/+$/, '');
        ...
        this.authentications = {
            ...
            'DatabaseAuth': {type: 'apiKey', 'in': 'header', name: 'x-db'},
            'UserAuth': {type: 'apiKey', 'in': 'header', name: 'x-saldiuser'}
        }
