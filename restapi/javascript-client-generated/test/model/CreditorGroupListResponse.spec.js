...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreditorGroupListResponse', function() {
      beforeEach(function() {
        instance = new PblmRestApi.CreditorGroupListResponse();
      });

      it('should create an instance of CreditorGroupListResponse', function() {
        // TODO: update the code to test CreditorGroupListResponse
        expect(instance).to.be.a(PblmRestApi.CreditorGroupListResponse);
      });
