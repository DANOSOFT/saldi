...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreditorGroupResponse', function() {
      beforeEach(function() {
        instance = new PblmRestApi.CreditorGroupResponse();
      });

      it('should create an instance of CreditorGroupResponse', function() {
        // TODO: update the code to test CreditorGroupResponse
        expect(instance).to.be.a(PblmRestApi.CreditorGroupResponse);
      });
