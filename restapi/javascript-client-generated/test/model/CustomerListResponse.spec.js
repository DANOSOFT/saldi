...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomerListResponse', function() {
      beforeEach(function() {
        instance = new PblmRestApi.CustomerListResponse();
      });

      it('should create an instance of CustomerListResponse', function() {
        // TODO: update the code to test CustomerListResponse
        expect(instance).to.be.a(PblmRestApi.CustomerListResponse);
      });
