...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateCreditorGroupRequest', function() {
      beforeEach(function() {
        instance = new PblmRestApi.UpdateCreditorGroupRequest();
      });

      it('should create an instance of UpdateCreditorGroupRequest', function() {
        // TODO: update the code to test UpdateCreditorGroupRequest
        expect(instance).to.be.a(PblmRestApi.UpdateCreditorGroupRequest);
      });
