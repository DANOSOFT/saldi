...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateCustomerRequest', function() {
      beforeEach(function() {
        instance = new PblmRestApi.UpdateCustomerRequest();
      });

      it('should create an instance of UpdateCustomerRequest', function() {
        // TODO: update the code to test UpdateCustomerRequest
        expect(instance).to.be.a(PblmRestApi.UpdateCustomerRequest);
      });
