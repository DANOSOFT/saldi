...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VatListResponse', function() {
      beforeEach(function() {
        instance = new PblmRestApi.VatListResponse();
      });

      it('should create an instance of VatListResponse', function() {
        // TODO: update the code to test VatListResponse
        expect(instance).to.be.a(PblmRestApi.VatListResponse);
      });
