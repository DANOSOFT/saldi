...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateVatRequest', function() {
      beforeEach(function() {
        instance = new PblmRestApi.UpdateVatRequest();
      });

      it('should create an instance of UpdateVatRequest', function() {
        // TODO: update the code to test UpdateVatRequest
        expect(instance).to.be.a(PblmRestApi.UpdateVatRequest);
      });
