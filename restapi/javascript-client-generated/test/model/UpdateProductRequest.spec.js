...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateProductRequest', function() {
      beforeEach(function() {
        instance = new PblmRestApi.UpdateProductRequest();
      });

      it('should create an instance of UpdateProductRequest', function() {
        // TODO: update the code to test UpdateProductRequest
        expect(instance).to.be.a(PblmRestApi.UpdateProductRequest);
      });
