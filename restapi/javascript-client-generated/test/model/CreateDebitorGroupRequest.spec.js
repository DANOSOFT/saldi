...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateDebitorGroupRequest', function() {
      beforeEach(function() {
        instance = new PblmRestApi.CreateDebitorGroupRequest();
      });

      it('should create an instance of CreateDebitorGroupRequest', function() {
        // TODO: update the code to test CreateDebitorGroupRequest
        expect(instance).to.be.a(PblmRestApi.CreateDebitorGroupRequest);
      });
