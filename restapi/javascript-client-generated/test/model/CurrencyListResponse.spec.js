...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CurrencyListResponse', function() {
      beforeEach(function() {
        instance = new PblmRestApi.CurrencyListResponse();
      });

      it('should create an instance of CurrencyListResponse', function() {
        // TODO: update the code to test CurrencyListResponse
        expect(instance).to.be.a(PblmRestApi.CurrencyListResponse);
      });
