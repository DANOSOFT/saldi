...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DebitorGroupListResponse', function() {
      beforeEach(function() {
        instance = new PblmRestApi.DebitorGroupListResponse();
      });

      it('should create an instance of DebitorGroupListResponse', function() {
        // TODO: update the code to test DebitorGroupListResponse
        expect(instance).to.be.a(PblmRestApi.DebitorGroupListResponse);
      });
