...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DebitorGroupResponse', function() {
      beforeEach(function() {
        instance = new PblmRestApi.DebitorGroupResponse();
      });

      it('should create an instance of DebitorGroupResponse', function() {
        // TODO: update the code to test DebitorGroupResponse
        expect(instance).to.be.a(PblmRestApi.DebitorGroupResponse);
      });
      ...
      it('should have the property commissionPercentage (base name: "commissionPercentage")', function() {
        // TODO: update the code to test the property commissionPercentage
        expect(instance).to.have.property('commissionPercentage');
        // expect(instance.commissionPercentage).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property kodenr (base name: "kodenr")', function() {
        // TODO: update the code to test the property kodenr
        expect(instance).to.have.property('kodenr');
        // expect(instance.kodenr).to.be(expectedValueLiteral);
      });
