...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateVatRequest', function() {
      beforeEach(function() {
        instance = new PblmRestApi.CreateVatRequest();
      });

      it('should create an instance of CreateVatRequest', function() {
        // TODO: update the code to test CreateVatRequest
        expect(instance).to.be.a(PblmRestApi.CreateVatRequest);
      });
