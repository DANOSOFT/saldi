<?php
	@session_start();
	$s_id=session_id();
// -------kreditor/modtag.php-------patch 3.4.4-------2014.10.05-----
// LICENS
//
...
#cho __LINE__." update batch_kob set rest='$rest' where id = $r[id]<br>";
						db_modify("update batch_kob set rest='$ny_rest' where id = $r2[id]",__FILE__ . " linje " . __LINE__);
...
#cho __LINE__." update batch_kob set rest='$ny_rest' where id = $r2[id]<br>";
#cho __LINE__." update batch_kob set rest='$rest' where id = $r[id]<br>";
						db_modify("update batch_kob set antal=$ny_antal,ordre_id='$id',linje_id='$linje_id[$x]',rest='$ny_rest' where id = $r2[id]",__FILE__ . " linje " . __LINE__);
						db_modify("update batch_kob set antal=antal-$ny_antal,rest='$rest' where id = $r[id]",__FILE__ . " linje " . __LINE__);
						}	
/*
						else {
							$ny_rest=$rest+$r2['rest'];
