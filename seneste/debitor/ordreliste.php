<?php
// ---------------debitor/ordreliste.php---lap 3.4.3------2014-08-13----
// LICENS
//
...
#cho "select distinct($tmp) from ordrer where (art = 'DO' or art = 'DK') and $status<br>";			
...
#cho "G $nextfakt<br>";
		if ($valg=='faktura') {
			...
			$udlignet=0;
#cho "select udlignet from openpost where faktnr = '$row[fakturanr]' and konto_id='$row[konto_id]' and amount='$tmp'<br>";
...
if ($r['box1'] && $ialt!="0,00") {
	...
	print "<tr><td colspan=\"3\"><span title='Klik her for at importere en csv fil (OBS beta !!)'><a href=csv2ordre.php target=\"_blank\">CSV import</a></span></td><td colspan=\"".($colspan-3)."\" align=right><span title='Klik her for at fakturere alle ordrer p&aring; listen'><a href=massefakt.php target=\"_blank\" onClick=\"return MasseFakt('$tekst')\">Faktur&eacute;r alt</a></span></td></tr>";
