<?php
// --------includes/openpost.php ----- lap 3.4.3 ---- 2014.07.16 ---------------------------
// LICENS
//
...
#	print "<input style=\"width:50px\" type=\"submit\" value=\"$tekst\" name=\"find\"></td>";
	...
	if ($kontoart=='D') {
		...
		print "<tr><td colspan=\"3\" align=center>
			<span onClick=\"javascript:top100=window.open('top100.php','top100','$jsvars');top100.focus();\" title=\"$tekst1\"><input style=\"width:115px\" type=submit value=\"$tekst2\" name=\"submit\"></span>";
