<?php
// -----------------systemdata/syssetup.php----lap 3.4.4---2014-06-21----
// LICENS
//
...
if ($valg=='moms'){
	...
	$y=udskriv('SM',$x,$y,$art,$id,'S',$kodenr,$beskrivelse,$box1,'6' ,$box2,'6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','2');
	...
	print "<tr><td></td><td>Nr.</td><td align=\"center\"><span title='$spantekst1'>Beskrivelse</span></td><td align=\"center\"><span title='$spantekst2'>Konto<span></td><td align=\"center\"><span title='$spantekst3'>Sats</span></td></tr>\n";
	$y=udskriv('KM',$x,$y,$art,$id,"K",$kodenr,$beskrivelse,$box1,'6',$box2,'6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','2');
	print "<tr><td><br></td></tr>\n";
	...
	$y=udskriv('YM',$x,$y,$art,$id,"Y",$kodenr,$beskrivelse,$box1,'6',$box2,'6',$box3,'6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','2');
	print "<tr><td><br></td></tr>\n";
	...
	print "<tr><td></td><td>Nr.</td><td align=\"center\"><span title='$spantekst1'>Beskrivelse</span></td><td align=\"center\"><span title='$spantekst2'>Konto<span></td><td align=\"center\"><span title='$spantekst3'>Sats</span></td><td align=\"center\"> <span title='$spantekst4'>Modkonto</span></td></tr>\n";
	$y=udskriv('EM',$x,$y,$art,$id,"E",$kodenr,$beskrivelse,$box1,'6',$box2,'6',$box3,'6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','2');
	print "<tr><td><br></td></tr>\n";
	...
	$y=udskriv('MR',$x,$y,$art,$id,"R",$kodenr,$beskrivelse,$box1,'6',$box2,'6',$box3,'6',$box4,'6',$box5,'6',$box6,'6',$box7,'6','-','6','-','6','-','6','-','6','-','6','-','6','-','2');
}
elseif($valg=='debitor'){
...
#	print "<td align=\"center\"><span title = \"$spantilte\">Rabat</td>";
	...
	print "<td align=\"center\"><span title = \"$spantilte\">Provision</td>\n";
	$spantilte="Business to business!\nAfm&aelig;rk her,hvis der skal anvendes b2b priser ved salg til denne kundegruppe";
	print "<td align=\"center\"><span title = \"$spantilte\">B2B</td>\n";
	$spantilte="Omvendt betaligspligt!\nAfm&aelig;rk her,hvis denne kundegruppe er omfattet af omvendt betalingspligt";
 	print "<td align=\"center\"><span title = \"$spantilte\">OB</td></tr>\n";
	$y=udskriv('DG',$x,$y,$art,$id,'D',$kodenr,$beskrivelse,$box1,'6',$box2,'6',$box3,'10',$box4,'10',$box5,'6','-','4',$box7,'4',$box8,'checkbox',$box9,'checkbox','-','2','-','2','-','2','-','2','-','2');
	print "<tr><td><br></td></tr>\n";
	...
	print "<td align=\"center\" title=\"Omvendt betaligspligt!\nAfm&aelig;rk her,hvis denne leverandørgruppe er omfattet af omvendt betalingspligt\">O/B</td></tr>\n";
#	print "<td align=\"center\"><span title=\"Omvendt betaligspligt!\"Afm&aelig;rk her,hvis denne leverandørgruppe er omfattet af omvendt betalingspligt>O/B</span></td></tr>\n";
	$y=udskriv('KG',$x,$y,$art,$id,'K',$kodenr,$beskrivelse,$box1,'6',$box2,'6',$box3,'10',$box4,'10',$box5,'10',$box6,'6','-','6','-','6',$box9,'checkbox','-','6','-','6','-','6','-','6','-','2');
}
elseif($valg=='afdelinger'){
	...
	$y=udskriv('AFD',$x,$y,$art,$id,'&nbsp;',$kodenr,$beskrivelse,'-','2',"-",'2',"-",'2','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','2');
}
elseif($valg=='projekter'){
	print "<tr><td></td><td colspan=3 align=\"center\"><b>Projekter</td></tr>\n";
	print "<tr><td></td><td>Nr.</td><td>Beskrivelse</td></tr>\n";
	$y=udskriv('PRJ',$x,$y,$art,$id,'&nbsp;',$kodenr,$beskrivelse,'-','2',"-",'2',"-",'2','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','2');
}
elseif($valg=='lagre'){
	...
	$y=udskriv('LG',$x,$y,$art,$id,'&nbsp;',$kodenr,$beskrivelse,$box1,'2',"-",'2',"-",'2','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','6','-','2');
}
elseif($valg=='varer'){
	...
	if (db_fetch_array($q)){
		...
		$y=udskriv('VG',$x,$y,$art,$id,'&nbsp;',$kodenr,$beskrivelse,$box1,'4',$box2,'4',$box3,'4',$box4,'4',$box5,'4',$box6,'checkbox',$box7,'checkbox',$box8,'checkbox',$box10,'checkbox','-','2',$box11,'4',$box12,'4',$box13,'4',$box14,'4');
	} else {
		...
		print "<td title='Kontonummer for en af Varesalg uden for EU, Ydelsessalg uden for EU eller Vare- og ydelsessalg uden for EU (Rubrik C). Hvis en af de to f&oslash;rste angives, s&aring; skal kontonummeret v&aelig;re blandt de kontonumre, som summeres til en samlekonto for Vare- og ydelsessalg uden for EU (Rubrik C).'>for EU</td></tr>\n";
		$y=udskriv('VG',$x,$y,$art,$id,'&nbsp;',$kodenr,$beskrivelse,$box1,'4',$box2,'4',$box3,'4',$box4,'4',$box5,'4',$box6,'checkbox',$box7,'checkbox',$box8,'checkbox',$box9,'checkbox',$box10,'checkbox',$box11,'4',$box12,'4',$box13,'4',$box14,'4');
	}
	...
	$y=udskriv('VPG',$x,$y,$art,$id,'&nbsp;',$kodenr,$beskrivelse,$box1,'4',$box2,'4',$box3,'4',$box4,'4','-','6','-','2','-','0','-','0','-','0','-','0','-','0','-','0','-','0','-','0');
	...
	$y=udskriv('VTG',$x,$y,$art,$id,'&nbsp;',$kodenr,$beskrivelse,$box1,'4',$box2,'4',$box3,'7',$box4,'7','-','6','-','2','-','0','-','0','-','0','-','0','-','0','-','0','-','0','-','0');
	print "</tbody></table></td></tr>";
	print "<tr><td colspan=13><table><tbody>";
	...
	$y=udskriv('VRG',$x,$y,$art,$id,'&nbsp;',$kodenr,$beskrivelse,$box1,'2',$box2,'20',$box3,'20','-','2','-','4','-','2','-','4','-','2','-','7','-','7','-','0','-','0','-','0','-','0');
	print "</tbody></table></td></tr>";
}
...
##########################################################################################################################
function udskriv($a,$x,$y,$art,$id,$k,$kodenr,$beskrivelse,$box1,$b1,$box2,$b2,$box3,$b3,$box4,$b4,$box5,$b5,$box6,$b6,$box7,$b7,$box8,$b8,$box9,$b9,$box10,$b10,$box11,$b11,$box12,$b12,$box13,$b13,$box14,$b14) {
