...
$bm_col_daterange     = findtekst('5056|Datointerval:', $sprog_id);
$bm_date_hint         = findtekst('5057|dage omkring bilagsdatoen', $sprog_id);
$bm_col_amounttol     = findtekst('5058|Beløbstolerance:', $sprog_id);
$bm_chk_amount_tol    = findtekst('5059|Tillad afvigelse på 0,5 %', $sprog_id);
$bm_chk_include_posted = findtekst('5060|Medtag allerede bogførte bilag', $sprog_id);
$bm_col_match         = findtekst('5061|Match', $sprog_id);
$bm_badge_full        = findtekst('5062|100 % match', $sprog_id);
$bm_badge_date        = findtekst('5063|Dato matcher', $sprog_id);
$bm_badge_amount      = findtekst('5064|Beløb matcher', $sprog_id);
$bm_footer_count_tpl  = findtekst('5065|Viser $m resultater', $sprog_id);
$bm_match_selected    = findtekst('5066|Match valgte', $sprog_id);
$bm_confirm_uncertain = findtekst('5067|Nogle af de valgte matches er ikke 100 % sikre. Vil du fortsætte?', $sprog_id);
...
$bm_pin_open_tooltip  = findtekst('5068|Klik for at se bilaget', $sprog_id);
$bm_pin_zoom_out      = findtekst('5069|Zoom ud', $sprog_id);
$bm_pin_zoom_in       = findtekst('5070|Zoom ind', $sprog_id);
$bm_pin_fit_width     = findtekst('5071|Tilpas til bredde', $sprog_id);
$bm_pin_open_tab      = findtekst('5072|Åbn i ny fane', $sprog_id);
$bm_pin_unsupported   = findtekst('5073|Formatet kan ikke forhåndsvises', $sprog_id);
$bm_pin_load_error    = findtekst('5074|Kunne ikke indlæse dokumentet', $sprog_id);
