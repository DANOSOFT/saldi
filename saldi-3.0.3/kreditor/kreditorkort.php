<?php
// ----------kreditor/kreditorkort.php-(modul nr. 8)--------lap 2.1.9----2010.04.28------------
// LICENS
//
...
############################
		...
		if ($id==0) {
			...
			db_modify("update adresser set kontonr = '$kontonr',	firmanavn = '$firmanavn', addr1 = '$addr1', addr2 = '$addr2', postnr = '$postnr', bynavn = '$bynavn', land = '$land', kontakt = '$kontakt', tlf = '$tlf', fax = '$fax', email = '$email', web = '$web', betalingsdage= '$betalingsdage', kreditmax = '$kreditmax', betalingsbet = '$betalingsbet', cvrnr = '$cvrnr', notes = '$notes', gruppe = '$gruppe' ,bank_navn='$bank_navn',bank_reg='$bank_reg',bank_konto='$bank_konto',bank_fi='$bank_fi',erh='$erh',swift='$swift',felt_1='$felt_1',felt_2='$felt_2',felt_3='$felt_3',felt_4='$felt_4',felt_5='$felt_5',lukket='$lukket' where id = '$id'");
			for ($x=1; $x<=$ans_ant; $x++) {
				 $y=trim($posnr[$x]);
...
if (!$gruppe) {$gruppe=1;}
$q = db_select("select beskrivelse from grupper where art='KG' and kodenr='$gruppe'");
$r = db_fetch_array($q);
print "<td><SELECT NAME=gruppe value=\"$gruppe\"  onchange=\"javascript:docChange = true;\">\n";
print "<option>$gruppe:$r[beskrivelse]</option>\n";
$q = db_select("select * from grupper where art='KG' and kodenr!='$gruppe' order by kodenr");
