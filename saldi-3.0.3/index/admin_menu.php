<?php
// --index/admin_menu.php------lap 2.0.7------2009-05-19----------------
// LICENS
//
...
print "  <td  $top_bund width=\"10%\" align = \"center\">$font <a href=\"../http://saldi.dk/dok/komigang.html\" target=\"_blank\"><small>Vejledning</small></a></td>\n";
print "<td  $top_bund width=\"35%\"><small>&nbsp;</small></td>";
print "<td  $top_bund width=\"10%\" align = \"right\">$font <a href=\"logud.php\" accesskey=\"L\"><small>Logud</small></a></td>\n";
print "</tr></tbody></table></td></tr>\n<tr><td align=\"center\" valign=\"center\">\n";

print"<table width=\"20%\" align=\"center\" border=\"4\" cellspacing=\"5\" cellpadding=\"0\"><tbody>";
print"<tr>";
print"<td colspan=\"5\" height=\"35\" align=\"center\" background=\"../img/blaa2hvid_bg.gif\"><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\"><big><big><b>SALDI 2.0</b></big></big></td>";
print"</tr><tr>";
...
#	print"<td align=\"center\" height=\"35\" $stor_knap_bg><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\"><a onfocus=\"this.style.color='$bgcolor2'\" onblur=\"this.style.color='#000066'\" href=\"../admin/stdkontoplan.php\"><br></td>";
	...
	print"</tr><tr>";
	print"<td align=\"center\" height=\"35\" $stor_knap_bg><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\"><a onfocus=\"this.style.color='$bgcolor2'\" onblur=\"this.style.color='#000066'\" href=\"../admin/admin_brugere.php\">Brugere</td>";
}
print"</tr>";
print"</tbody></table>";
print"</td></tr>";
