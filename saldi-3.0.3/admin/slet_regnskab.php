...
// -------------/admin/slet_regnskab.php-----patch 2.1.4------2010.03.23--------
// LICENS
//
...
# 						print "Sletter regnskab: $regnskab[$x]<br>";
					...
					if ($r=db_fetch_array(db_select("select id from kundedata where regnskab_id='$id[$x]'",__FILE__ . " linje " . __LINE__))) {
							...
							db_modify("update kundedata set slettet='on',regnskab_id='$id[$x]' where regnskab='$regnskab[$x]'",__FILE__ . " linje " . __LINE__); 
						}
