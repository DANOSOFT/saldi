...
db_modify("update online set db='$tmp_db', brugernavn='$brugernavn', regnskabsaar='$regnskabsaar', revisor='1', rettigheder='111111111111111111111' where session_id='$s_id'");
$db=$tmp_db;
$db_id=$tmp_db_id;	
	include("../includes/online.php");
...
if (!$regnakabsaar) {
	$r=db_fetch_array(db_select("select MAX(kodenr) as regnskabsaar from grupper where art = 'RA'"));
	$regnskabsaar=$r['regnskabsaar']*1;
	include("../includes/connect.php");
	db_modify("update online set regnskabsaar='$regnskabsaar' where session_id='$s_id'");
	include("../includes/online.php");
}
