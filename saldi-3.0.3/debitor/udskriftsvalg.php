...
// ----------debitor/udskriftsvalg.php----------------lap 2.1.1----2009-11-02-------------
// LICENS
//
...
#	print "<body onload=\"javascript:window.close();\">";
	...
	print "<tr><td align=center> <a href='udskriftsvalg.php?id=$id&valg=-1'>Ordrebekr&aelig;ftelse</a></td></tr>";
	for ($x=1; $x<=$lev_nr; $x++) {
		print "<tr><td align=center> <a href='udskriftsvalg.php?id=$id&valg=$x'>F&oslash;lgeseddel $x</a></td></tr>";
	}
