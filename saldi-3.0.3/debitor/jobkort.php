<?php
// ------------- debitor/jobkort.php ----- (modul nr 6)------ lap 2.1.9 ----2010-04-27-------
// LICENS
//
...
print "<td onClick=\"JavaScript:opener.location.reload();\" width=\"10%\"$top_bund><a href=$returside?returside=$returside&id=$ordre_id&fokus=$fokus&konto_id=$select_id accesskey=L>".findtekst(30,$sprog_id)."</a><br></td>";
