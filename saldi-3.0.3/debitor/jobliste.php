<?php
// ------------debitor/jobliste.php---lap 2.1.9------2010-04-27----------
// LICENS
//
...
#else 
print "<td width=10% $top_bund><a href=debitor.php accesskey=L>".findtekst(30,$sprog_id)."</a></td>";
...
print "<td width=30% $top_bund align=center><br></td>";
if ($popup) print "<td width=10% $top_bund onClick=\"javascript:job=window.open('jobkort.php?returside=jobliste.php&konto_id=$konto_id','job','scrollbars=1,resizable=1');job.focus();\"><a accesskey=N href=jobliste.php?sort=$sort>".findtekst(39,$sprog_id)."</a></td>";
else print "<td width=10% $top_bund><a href=jobkort.php?returside=jobliste.php&konto_id=$konto_id accesskey=N>".findtekst(39,$sprog_id)."</a></td>";
print "</td></tr>\n";
