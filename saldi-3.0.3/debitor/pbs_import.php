<?php
// ----------debitor/pbs_import.php------------patch 2.0.7-----2009.04.03-----------
// LICENS
//
					...
					if ($BS002) {
						...
						if ($BS012) {
							if (substr($linje,0,5)=='BS042') {
								...
								print  "Kundenr: $kundenr[$x] | pbs_nr $pbsnr[$x]<br>";
								db_modify("update adresser set pbs_nr='$pbsnr[$x]' where kontonr = '$kundenr[$x]' and art = 'D'",__FILE__ . " linje " . __LINE__);
							}
						}
					}
				} 
