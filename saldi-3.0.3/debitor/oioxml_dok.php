...
// ---------debitor/oioxml_dok.php----patch 2.0.8---2009-06-24-17:11--
// LICENS
//
...
<table width=\"100%\" height=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tbody>
	<tr><td height = \"25\" align=\"center\" valign=\"top\">
		<table width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"4\" cellpadding=\"0\"><tbody>
			<td width=\"10%\" align=center><div class=\"top_bund\"><a href=\"../includes/luk.php\" accesskey=L>Luk</a></div></td>
...
print "<p>Du skal benytte et andet program til at sende selve OIOXML-filen.</p>\n\n";
print "<p>Under nogle af Microsoft Windows-styresystemerne kan \n";
print "<a href=\"http://ibizcenter.dk/kom-i-gang/nemhandel-programmet.aspx\">NemHandel-programmet</a>\n";
print "frit hentes og benyttes.</p>\n\n";
print "<p>Som det kan l&aelig;ses p&aring; ovenst&aring;ende link, s&aring; kr&aelig;ver det ogs&aring;, \n";
print "at du har et medarbejdercertifikat og et funktionscertifikat fra DanID samt to forskellige e-mail-adresser, \n";
print "som <i>udelukkende</i> benyttes til NemHandel.</p>\n\n";

print "\n<h1>Test OIOXML-filen</h1>\n\n";
print "<p>Hvis du vil teste OIOXML-filen eller NemHandel-programmet ikke kan afsende den, s&aring; kan validering af filen ske med \n";
