<?php
// -----------includes/std_func.php-------lap 3.0.2----2010-05-31-----
// LICENS
//
...
if (!function_exists('dkdecimal')) {
	...
	{
		if ($tal>0) $tal=round($tal+0.0001,2);#Afrunding tilf�jet 2009.01.26 grundet diff i ordre 98 i saldi_104
