...
if ($kodenr) {
	...
	while ($row = db_fetch_array($query)) {
		...
		print "<td align=center><a href=valutakort.php?id=$row[id]&kodenr=$kodenr> Ret</a><br></td>";
		print "</tr>";
	}
}
...
function ny_valuta()
{
	$isovaluta = array("AUD","BGN","CAD","CHF","CNY","CZK","EEK","EUR","GBP","HKD","HRK","HUF","IDR","JPY","KRW","LTL","LVL","MYR","NOK","NZD","PHP","PLN","RON","RUB","SDR","SEK","SGD","THB","TRY","USD","ZAR");
