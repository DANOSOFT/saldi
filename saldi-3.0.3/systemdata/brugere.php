...
// --------------systemdata/brugere.php------lap 2.1.2----2009-12-31------
// LICENS
//
...
#			print "<tr><td align=center>Der findes allerede en bruger med brugenavn: $brugernavn!</td></tr>";
			...
			db_modify("insert into brugere (brugernavn,kode,rettigheder,regnskabsaar,ansat_id) values ('$brugernavn','$kode','$rettigheder','$regnaar',$ansat_id[0])");
		}
	}
	elseif ((strstr($submit,'Opdat'))&&($brugernavn)) {
		db_modify("update brugere set brugernavn='$brugernavn', kode='$kode', rettigheder='$rettigheder', ansat_id=$ansat_id[0] where id=$id");
	}
...
while ($row = db_fetch_array($query)) {
	if ($row['id']!=$ret_id) {
		if ($row['ansat_id']) {
			$r2 = db_fetch_array(db_select("select initialer from ansatte where id = $row[ansat_id]"));
		}	else {$r2['initialer']='';}
...
if ($ret_id) {
	...
	print "<td><input type=text size=20 name=$tmp value='$row[brugernavn]'></td>";
	if (substr($row[rettigheder],0,1)==0) {print "<td><input type=checkbox name=kontoplan></td>";}
	else {print "<td><input type=checkbox name=kontoplan checked></td>";}
	if (substr($row[rettigheder],1,1)==0) {print "<td><input type=checkbox name=indstillinger></td>";}
	else {print "<td><input type=checkbox name=indstillinger checked></td>";}
	if (substr($row[rettigheder],2,1)==0) {print "<td><input type=checkbox name=kassekladde></td>";}
	else {print "<td><input type=checkbox name=kassekladde checked></td>";}
	if (substr($row[rettigheder],3,1)==0) {print "<td><input type=checkbox name=regnskab></td>";}
	else {print "<td><input type=checkbox name=regnskab checked></td>";}
	if (substr($row[rettigheder],4,1)==0) {print "<td><input type=checkbox name=finansrapport></td>";}
	else {print "<td><input type=checkbox name=finansrapport checked></td>";}
	if (substr($row[rettigheder],5,1)==0) {print "<td><input type=checkbox name=debitorordre></td>";}
	else {print "<td><input type=checkbox name=debitorordre checked></td>";}
	if (substr($row[rettigheder],6,1)==0) {print "<td><input type=checkbox name=debitorkonti></td>";}
	else {print "<td><input type=checkbox name=debitorkonti checked></td>";}
	if (substr($row[rettigheder],7,1)==0) {print "<td><input type=checkbox name=kreditorordre></td>";}
	else {print "<td><input type=checkbox name=kreditorordre checked></td>";}
	if (substr($row[rettigheder],8,1)==0) {print "<td><input type=checkbox name=kreditorkonti></td>";}
	else {print "<td><input type=checkbox name=kreditorkonti checked></td>";}
	if (substr($row[rettigheder],9,1)==0) {print "<td><input type=checkbox name=varer></td>";}
	else {print "<td><input type=checkbox name=varer checked></td>";}
	if (substr($row[rettigheder],10,1)==0) {print "<td><input type=checkbox name=enheder></td>";}
	else {print "<td><input type=checkbox name=enheder checked></td>";}
	if (substr($row[rettigheder],11,1)==0) {print "<td><input type=checkbox name=backup></td>";}
	else {print "<td><input type=checkbox name=backup checked></td>";}
	if (substr($row[rettigheder],12,1)==0) {print "<td><input type=checkbox name=debitorrapport></td>";}
	else {print "<td><input type=checkbox name=debitorrapport checked></td>";}
	if (substr($row[rettigheder],13,1)==0) {print "<td><input type=checkbox name=kreditorrapport></td>";}
	else {print "<td><input type=checkbox name=kreditorrapport checked></td>";}
	if (substr($row[rettigheder],14,1)==0) {print "<td><input type=checkbox name=produktionsordre></td>";}
	else {print "<td><input type=checkbox name=produktionsordre checked></td>";}
	if (substr($row[rettigheder],15,1)==0) {print "<td><input type=checkbox name=varerapport></td>";}
	else {print "<td><input type=checkbox name=varerapport checked></td>";}
	print "</tr>";
...
#			print "<input type = hidden name=ansat_id[$x] value=$ansat_id[$x]>";
	...
	print "<td><input type=checkbox name=kontoplan></td>";
	print "<td><input type=checkbox name=indstillinger></td>";
	print "<td><input type=checkbox name=kassekladde></td>";
	print "<td><input type=checkbox name=regnskab></td>";
	print "<td><input type=checkbox name=finansrapport></td>";
	print "<td><input type=checkbox name=debitorordre></td>";
	print "<td><input type=checkbox name=debitorkonti></td>";
	print "<td><input type=checkbox name=kreditorordre></td>";
	print "<td><input type=checkbox name=kreditorkonti></td>";
	print "<td><input type=checkbox name=varer></td>";
	print "<td><input type=checkbox name=enheder></td>";
	print "<td><input type=checkbox name=backup></td>";
	print "<td><input type=checkbox name=debitorrapport></td>";
	print "<td><input type=checkbox name=kreditorrapport></td>";
	print "<td><input type=checkbox name=produktionsordre></td>";
	print "<td><input type=checkbox name=varerapport></td>";
	print "</tr>";
