<?php
// -----------------systemdata/syssetup.php----lap 3.0.3---2010-05-31----
// LICENS
//
...
if ($_POST){ 
	...
	for($x=0; $x<=$antal; $x++) {
		...
		if ($art[$x]=='VPG') {
			list($box1[$x],$box2[$x],$box3[$x],$box4[$x])=split(";",opdater_varer($kodenr[$x],$art[$x],$box1[$x],$box2[$x],$box3[$x],$box4[$x])); 
		} 
		if ($art[$x]=='VTG') {
			list($box1[$x],$box2[$x],$box3[$x],$box4[$x])=split(";",opdater_varer($kodenr[$x],$art[$x],$box1[$x],$box2[$x],$box3[$x],$box4[$x])); 
		} 
...
#	print "<td align=center><span title = \"$spantilte\">Rabat</td>";
	...
	$y=udskriv('DG', $x, $y, $art, $id, 'D', $kodenr, $beskrivelse, $box1, '6', $box2, '6', $box3, '10', $box4, '10', $box5, '6', '-', '4', $box7, '4', '-', '6', '-', '6', '-', '6', '-', '6', '-', '6', '-', '6');
	print "<tr><td><br></td></tr>\n";
...
elseif($valg=='varer'){
	...
	if (db_fetch_array($q)){
		...
		print "<tr><td align=center></td><td></td><td></td><td align=center>Lager-</td><td align=center>Lager-</td><td align=center>Vare-</td><td align=center>Vare-</td><td align=center>Lager-</td><td align=center>Moms-</td><td align=center>Lager-</td><td align=center>Opera-</td></tr>\n";
		print "<tr><td></td><td>Nr.</td><td align=center>Beskrivelse</td><td align=center>tilgang</td><td align=center>tr&aelig;k</td><td align=center>k&oslash;b</td><td align=center>salg</td><td align=center>regulering</td><td align=center>fri</td><td align=center>f&oslash;rt</td><td align=center>tion</td></tr>\n";
		$y=udskriv('VG', $x, $y, $art, $id, '&nbsp;', $kodenr, $beskrivelse, $box1, '6', $box2, '6', $box3, '6', $box4, '6', $box5, '6', '-', '2', $box7, 'checkbox', $box8, 'checkbox', $box10, 'checkbox', '-', '2');
	} else {
		print "<tr><td colspan=13 align=center><b>Varegrupper</td></tr><tr><td colspan=13><hr></td></tr>\n";
		print "<tr><td align=center></td><td></td><td></td><td align=center>Lager-</td><td align=center>Lager-</td><td align=center>Vare-</td><td align=center>Vare-</td><td align=center>Lager-</td><td align=center>Moms-</td><td align=center>Lager-</td><td align=center>Batch-</td><td align=center>Opera-</td></tr>\n";
		print "<tr><td></td><td>Nr.</td><td align=center>Beskrivelse</td><td align=center>tilgang</td><td align=center>tr&aelig;k</td><td align=center>k&oslash;b</td><td align=center>salg</td><td align=center>regulering</td><td align=center>fri</td><td align=center>f&oslash;rt</td><td align=center>kontrol</td><td align=center>tion</td></tr>\n";
		$y=udskriv('VG', $x, $y, $art, $id, '&nbsp;', $kodenr, $beskrivelse, $box1, '6', $box2, '6', $box3, '6', $box4, '6', $box5, '6', '-', '2', $box7, 'checkbox', $box8, 'checkbox', $box9, 'checkbox', $box10, 'checkbox');
	}
...
global $charset;
	...
	for ($i=0; $i<=$x; $i++) {
		...
		if ($art[$i]==$a){
			print "<tr><td>";
			print "$k</td>";
			print "<td><input class=\"inputbox\" type=\"text\" style=\"text-align:right\" size=$size name=kodenr[$i] value=$kodenr[$i]></td>";
			print "<td><input class=\"inputbox\" type=\"text\" size=40 name=beskrivelse[$i] value=\"$beskrivelse[$i]\"></td>";
			if (($box1[$i]!="-") &&($b1!="checkbox")){
				if ($art[$i]=='VRG') {
					print "<td><SELECT NAME=box1[$i] style=\"width: 4em\">";
					if ($box1[$i] == 'amount') {
					...
					print "<td><input class=\"inputbox\" type=\"text\" style=\"text-align:right\" size=$b1 name=box1[$i] value='$box1[$i]'></td>";
				}
			} elseif($b1=="checkbox") {
	...
	if (($k!='R')||(!$momsrapport)) {
		...
		print "<tr>";
		print "<td>$k</td>";			
		print "<td><input class=\"inputbox\" type=\"text\" size=$size name=kodenr[$y]></td>";
...
#			print "<td><input class=\"inputbox\" type=\"text\" style=\"text-align:right\" size=$b1 name=box1[$y]></td>";
		...
		if (($box2!="-")&&($b2!="checkbox")) {print "<td><input class=\"inputbox\" type=\"text\" style=\"text-align:right\" size=$b2 name=box2[$y]></td>";}
		elseif($b2=="checkbox") {print "<td><input class=\"inputbox\" type=\"checkbox\" name=box2[$y]></td>";}
		print "<input type = hidden name=id[$y] value='0'><input type = hidden name=kode[$y] value='$k'><input type = hidden name=art[$y] value=$a>";
		if (($box3!="-")&&($b3!="checkbox")) {print "<td><input class=\"inputbox\" type=\"text\" style=\"text-align:right\" size=$b3 name=box3[$y]></td>";}
		elseif($b3=="checkbox") {print "<td><input class=\"inputbox\" type=\"checkbox\" name=box3[$y]></td>";}
		print "<input type = hidden name=id[$y] value='0'><input type = hidden name=kode[$y] value='$k'><input type = hidden name=art[$y] value=$a>";
		if (($box4!="-")&&($b4!="checkbox")) {print "<td><input class=\"inputbox\" type=\"text\" style=\"text-align:right\" size=$b4 name=box4[$y]></td>";}
