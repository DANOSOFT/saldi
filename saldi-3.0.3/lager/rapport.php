...
// -----------lager/rapport.php------------patch 2.0.9-------2009.08.19----
// LICENS
//
...
#	print "</tbody></table>"; #B slut
	...
	if ($popup) print "<tr><td ALIGN=center onClick=\"javascript:lagerstatus=window.open('lagerstatus.php','lagerstatus','$jsvars');lagerstatus.focus();\"><span title='Se lagerstatus p&aring; vilk&aring;rlig dato'><input type=submit value=\"Lagerstatus\" name=\"submit\"></span></td></tr>";
#	else print "<tr><td colspan=3 ALIGN=center onClick=\"javascript:lagerstatus=window.open('lagerstatus.php','lagerstatus','$jsvars');lagerstatus.focus();\"><span title='Se lagerstatus p&aring; vilk&aring;rlig dato'><input type=submit value=\"Lagerstatus\" name=\"submit\"></span></td></tr>";
	else print "<tr><td ALIGN=center><form action=lagerstatus.php><span title='Se lagerstatus p&aring; vilk&aring;rlig dato'><input type=submit value=\"Lagerstatus\" name=\"submit\"></span></form></td></tr>";
	print "</tbody></table>\n";
	print "</td></tr>";
