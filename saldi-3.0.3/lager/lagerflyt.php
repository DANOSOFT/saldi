...
for ($y=1; $y<=$batch_kob_antal; $y++) {
  ...
  print "<tr><td>$font<span title='K&oslash;bsordre: $ordrenr[$y]'><a href=../kreditor/ordre.php?id=$kobs_ordre_id[$y] target=\"_blank\"> $max_antal[$y]</a></td>";
  ...
  elseif ($res_ordre_id[$y]) {print "<td colspan=2>$font<small>Varereservation p&aring; ordrenr:&nbsp;</small><a href=../debitor/ordre.php?id=$res_ordre_id[$y] target=\"_blank\">$res_ordrenr[$y]</a></td>";}
...
print "<tr><td colspan=3><hr></td></tr>";
print "<tr><td align=center colspan=3 onClick=\"javascript=opener.location.reload()\"><input type=submit value=\"Gem\" name=\"submit\">&nbsp;&nbsp;<input type=submit value=\"Luk\" name=\"submit\"></td></tr>";
print "</form> </tr>";
