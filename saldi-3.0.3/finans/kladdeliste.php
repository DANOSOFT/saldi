<?php
// ---------finans/kladdeliste.php----------Patch 2.0.7---------2009.04.29------------
// LICENS
//
...
if (($sort == 'id')&&(!$rf)) {print "<td width = 5%><b><a href=kladdeliste.php?sort=id&rf=desc>Id</a></b></td>\n";}
else {print "<td width = 5% title='Klik her for at sortere p&aring; ID'><b><a href=kladdeliste.php?sort=id>Id</a></b></td>\n";}
if (($sort == 'kladdedate')&&(!$rf)) {print "<td width = 10%><b><a href=kladdeliste.php?sort=kladdedate&rf=desc>Dato</a></b></td>\n";}
else {print "<td width = 10% title='Klik her for at sortere p&aring; dato'><b><a href=kladdeliste.php?sort=kladdedate>Dato</a></b></td>\n";}
if (($sort == 'oprettet_af')&&(!$rf)) {print "<td><b><a href=kladdeliste.php?sort=oprettet_af&rf=desc>Ejer</a></b></td>\n";}
else {print "<td title='Klik her for at sortere p&aring; ejer (den der har oprettet kassekladden)'><b><a href=kladdeliste.php?sort=oprettet_af>Ejer</a></b></td>\n";}
if (($sort == 'kladdenote')&&(!$rf)) {print "<td width = 70%><b><a href=kladdeliste.php?sort=kladdenote&rf=desc>Bem&aelig;rkning</a></b></td>\n";}
else {print "<td width = 70% title='Klik her for at sortere p&aring; bem&aelig;rkning'><b><a href=kladdeliste.php?sort=kladdenote>Bem&aelig;rkning</a></b></td>\n";}
if (($sort == 'bogforingsdate')&&(!$rf)) {print "<td align=center><b><a href=kladdeliste.php?sort=bogforingsdate&rf=desc>Bogf&oslash;rt</a></b></td>\n";}
else {print "<td align=center><b><a href=kladdeliste.php?sort=bogforingsdate>Bogf&oslash;rt</a></b></td>\n";}
if (($sort == 'bogfort_af')&&(!$rf)) {print "<td><b><a href=kladdeliste.php?sort=bogfort_af&rf=desc>Af</a></b></td>\n";}
else {print "<td title='Klik her for at sortere p&aring; \"bogf&oslash;rt af\"'><b><a href=kladdeliste.php?sort=bogfort_af>af</a></b></td>\n";}
print "</tr>\n";
$tjek=0;
#$sqhost = "localhost";
	if ($vis == 'alle') {$vis = '';} 
