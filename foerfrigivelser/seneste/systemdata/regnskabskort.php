<?php
// ----systemdata/regnskabskort.php	----- lap 2.0 ----2008-04-24-------------------
// LICENS
//
...
Print "<td width=10% $top_bund>$font <small><a href=regnskabskort.php accesskey=N>Nyt</a><br></small></td>";
...
function aar_1($id, $kodenr, $beskrivelse, $startmd, $startaar, $slutmd, $slutaar, $aaben)
{
	...
	print "<td align=center>$font<input $type style=\"text-align:right\" size=2 name=startmd value=$startmd></td>";
	print "<td align=center>$font<input $type style=\"text-align:right\" size=4 name=startaar value=$startaar></td>";
	print "<td align=center>$font<input $type style=\"text-align:right\" size=2 name=slutmd value=$slutmd></td>";
	print "<td align=center>$font<input $type style=\"text-align:right\" size=4 name=slutaar value=$slutaar></td>";
	...
	print "<tr><td align=center>$font<small>1.&nbsp;faktnummer</td><td align=center>$font<small>1.&nbsp;modtagelsesnummer</td><tr>";  
	print "<tr><td align=center>$font<input type=text style=\"text-align:right\" size=4 name=fakt value=$fakt></td>";
	print "<td align=center>$font<input type=text style=\"text-align:right\" size=4 name=modt value=$modt></td>";
	...
	print "<tr><td align=center>$font<small>Undlad bilagsnummer til faktura</td><td align=center>$font<input type=checkbox name=no_faktbill $no_faktbill></td></tr>";
	print "<tr><td align=center>$font<small>Brug fakturanummer som bilagsnummer</td><td align=center>$font<input type=checkbox name=faktbill $faktbill></td></tr>";
	print "<tr><td align=center>$font<small>Brug modtagelsesnummer som bilagsnummer</td><td align=center>$font<input type=checkbox name=modtbill $modtbill></td></tr>";
	...
	while ($row = db_fetch_array($query)) {
		...
		print "<td width=10 align=right>$font<input type=text style=\"text-align:right\" size=10 name=debet[$y] value=$debet[$y]></td>";
		print "<td width=10 align=right>$font<input type=text style=\"text-align:right\" size=10 name=kredit[$y] value=$kredit[$y]></td></tr>";
	}
...
function aar_x($id, $kodenr, $beskrivelse, $startmd, $startaar, $slutmd, $slutaar, $aaben)
{
	...
	print "<td align=center>$font<input readonly=readonly style=\"text-align:right\" size=2 name=startmd value=$startmd></td>";
	print "<td align=center>$font<input readonly=readonly style=\"text-align:right\" size=4 name=startaar value=$startaar></td>";
	print "<td align=center>$font<input type=text style=\"text-align:right\" size=2 name=slutmd value=$slutmd></td>";
		print "<td align=center>$font<input type=text style=\"text-align:right\" size=4 name=slutaar value=$slutaar></td>";
	if (strstr($aaben,'on')) {print "<td align=center>$font<input type=checkbox name=aaben checked></td>";}
	else {print "<td align=center>$font<input type=checkbox name=aaben></td>";}
