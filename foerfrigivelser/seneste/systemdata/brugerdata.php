<?php
// -----------------systemdata/brugerdata.php ------lan 1.9.1e-----03.04.08----------
// LICENS
//
...
// copyright (c) 2003-2008 DANOSOFT ApS
// ----------------------------------------------------------------------
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"><tbody>
	<tr><td align="center" valign="top">
		<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"><tbody><td>
			...
			<td width="10%" <?php echo $top_bund ?>><font face="Helvetica, Arial, sans-serif" color="#000066"><small><a href=../index/menu.php accesskey=L>Luk</a></small></td>
			<td width="80%" <?php echo $top_bund ?>><font face="Helvetica, Arial, sans-serif" color="#000066"><small>Brugerindstillinger for <?php print $brugernavn." | ".$regnskab ?></small></td>
			<td width="10%" <?php echo $top_bund ?>><font face="Helvetica, Arial, sans-serif" color="#000066"><small><br></small></td>
			</tbody></table></td>
		</tbody></table>
	</td></tr>
	<tr><td align="center" valign="top">
...
#	print "<td><a href=regnskabskort.php?id=$row[id]><font face=\"Helvetica, Arial, sans-serif\" color=\"$color\">$row[kodenr]</a><br></small></td>";
	...
	if (($row[kodenr]!=$regnaar)&&($row[box5]=='on')) {
		print "<td><small><a href=brugerdata.php?aktiver=$row[kodenr]>$font S&aelig;t aktivt</a><br></small></td>";
	}
...
if (($brugernavn!='test')&&($db!='test')) print "<tr><td>$font<span title='Der kan ikke skrives i dette felt i demo versionen';> Nyt password</td><td><input type=password size=20 name=nykode1></td></tr>";
else print "<tr><td>$font Nyt password</td><td><input type=password readonly size=20 name=nykode1 value=test></td></tr>";
