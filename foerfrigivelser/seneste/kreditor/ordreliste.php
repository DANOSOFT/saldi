<?php
// -----------kreditor/ordreliste.php-------lap 1.9.1e-------04.04.2008---
// LICENS
//
...
print "<table width=100% align=center border=0 cellspacing=2 cellpadding=2><tbody>";
print "<td width=10% $top_bund>$font $color<small><a href=../includes/luk.php accesskey=L>Luk</a></small></td>";
...
print "<td width=10% $top_bund onClick=\"javascript:kordre=window.open('ordre.php?returside=ordreliste.php','kordre','scrollbars=1,resizable=1');ordre.focus();\">$font<small><a accesskey=N href=ordreliste.php?sort=$sort&valg=$valg>Ny</a></small></td>";
print "</tbody></table>";
print "</td></tr>";
