<?php
	@session_start();
	$s_id=session_id();
// -------kreditor/modtag.php-------patch 1.9.2a------------
// LICENS
//
...
# lager fjernet fra nedenstaaende linje 030306 - PHR - Pris fjernet 06.04.08 - Prisen skal ikke saettes ved modtagelse
				db_modify("insert into batch_kob(vare_id, linje_id, kobsdate, ordre_id, antal) values ($vare_id[$x], $linje_id[$x], '$levdate', $id, $leveres[$x])");
