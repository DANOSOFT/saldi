...
if ($udskriv) {
	...
	print "<tr><td width=40%><br></td><td $top_bund title=\"Klik på knappen for at &aring;bne betalingsfilen eller h&oslash;jreklik for at gemme\"> $font<a href='$filnavn'>Se / gem betalingsfil</a></td><td width=40%><br></td></tr>";
} else { 
...
function betalingskontrol($erh, $fra_kto,$egen_ref,$til_kto,$kort_ref,$belob,$valuta,$betalingsdato)
{
	...
	if (usdecimal($belob)<0.01) $k4="Bel&oslash;b skal være st&oslash;rre end 0";
