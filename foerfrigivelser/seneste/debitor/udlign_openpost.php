...
@session_start();
$s_id=session_id();
// -----------------------------------------------------debitor/udlign_openpost.php-------patch 1.0.4------------
// LICENS><small><small>
//
...
} else print "<meta http-equiv=\"refresh\" content=\"0;URL=rapport.php?rapport=kontokort.php\">";
...
print "<tr><td colspan=8 align=center><a href=rapport.php?rapportart=Kontokort&regnaar=$regnaar&maaned_fra=$maaned_fra&maaned_til=$maaned_til&konto_fra=$konto_fra&konto_til=$konto_til&submit=ok>$font<small><small>Luk</small></small></a></td></tr>";
...
print "<form name=kontoudtog action=udlign_openpost.php method=post>";
if ($diff!=0) {
