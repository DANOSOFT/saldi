...
// ---------------------------------------------debitor/historik.php-----lap 1.9.3-------2008-04-15-----------
// LICENS
//
...
while ($r0 = db_fetch_array($q0)) {
	...
	if (substr($vis_liste,$x,1)=='1') {
		...
		print "<tr>
			<td><small><b>$font <a href=historik.php?ny_sort=kontonr&sort=$tmp>Kundenr</b></small></td>
			<td><small><b>$font <a href=historik.php?ny_sort=firmanavn&sort=$tmp>Navn</a></b></small></td>
			<td><small><b>$font <a href=historik.php?ny_sort=postnr&sort=$tmp>Postnr</a></b></small></td>
			<td><small><b>$font <a href=historik.php?ny_sort=bynavn&sort=$tmp>By</a></b></small></td>
			<td><small><b>$font <a href=historik.php?ny_sort=tlf&sort=$tmp>Telefon</a></b></small></td>
			<td><small><b>$font <a href=historik.php?ny_sort=Oprettet&sort=$tmp>Oprettet</a></b></small></td>
			<td><small><b>$font <a href=historik.php?ny_sort=kontaktet&sort=$tmp>Kontaktet</a></b></small></td>
			<td><small><b>$font <a href=historik.php?ny_sort=kontaktes&sort=$tmp>Kontaktes</a></b></small></td>
			<td><small><b>$font Init.</b></small></td>
		</tr>";
		if ($sort) {
			if ($sort=='initialer' || $sort=='initialer desc') $q1 = db_select("select adresser.* from adresser, ansatte where adresser.art = 'D' and adresser.gruppe=$r0[kodenr] and ansatte.konto_id=adresser.id order by ansatte.$sort");
			else $q1 = db_select("select * from adresser where art = 'D' and gruppe=$r0[kodenr] order by $sort");
