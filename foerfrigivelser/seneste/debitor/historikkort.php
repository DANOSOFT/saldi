<?php
// ------------- debitor/historikkort.php ----- (modul nr 6)------ lap 1.9.3 ---2008-04-15-------
// LICENS
//
...
print "<td width=\"80%\"$top_bund>$font<small>Historik for debitor</small></td>\n";
...
print "<tr><td>$font $postnr $bynavn</td><td>$font $land</td><td>$font</td><td>$font Seneste kontakt</td><td>$font $kontaktet</td></tr>\n";
...
while ($r = db_fetch_array($q)){
	...
	print "<tr><td>$font $r1[navn] =&gt; $r2[navn]<br>$kontaktet &nbsp; $kontaktes<br>";
#	if ($r[notedate]==date("Y-m-d")) 
	...
	print "</td><td colspan='4' style='vertical-align:top'>$font $notat</td></tr>";
	print "<tr><td colspan=6><hr></td></tr>";
}
?>
</tbody>
