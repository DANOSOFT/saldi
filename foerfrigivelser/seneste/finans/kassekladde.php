...
// ------------------finans/kassekladde.php------------lap 1.9.3c---10.04.08----
// LICENS
//
...
#echo "insert into tmpkassekl (lobenr, id, bilag, transdate, beskrivelse, d_type, debet, k_type, kredit, faktura, amount, momsfri, afd, kladde_id, projekt, ansat, valuta) values ('$x', '$id[$x]', '$bilag[$x]', '$dato[$x]', '$beskrivelse[$x]', '$d_type[$x]', '$debet[$x]', '$k_type[$x]', '$kredit[$x]', '$faktura[$x]', '$belob[$x]', '$momsfri[$x]', '$afd[$x]', '$kladde_id', '$projekt[$x]', '$ansat[$x]', '$valuta[$x]')<br>";
...
#		if (($k_type[$y]!="D")&&($k_type[$y]!="K")) $k_type[$y]="F"; #phr 20070801
	...
	for ($y=1; $y<=$x; $y++) {
		...
		$q= "select valuta.kurs from valuta, grupper where grupper.art='VK' and grupper.box1='$valuta[$y]' and valuta.gruppe=grupper.kodenr and valuta.valdate < '$transdate[$y]' order by valdate desc";
			if ($r=db_fetch_array(db_select($q))) {
