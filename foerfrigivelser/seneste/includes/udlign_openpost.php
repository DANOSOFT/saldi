...
@session_start();
$s_id=session_id();
// -----------------------------------------------------debitor/udlign_openpost.php-------patch 1.0.9------------
// LICENS><small><small>
//
...
if ($diff<0.01) print "<tr><td colspan=10 align=center>$font<small><small><input type=submit value=\"Udlign\" name=\"submit\"></td></tr>";
