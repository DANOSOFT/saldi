<?php
// -------------------- systemdata/diverse.php ------ patch 3.2.5--2011-11-15--------
//
...
if ($_POST) {
	...
	#######################################################################################
		...
		elseif ($id==0){
			db_modify("insert into grupper (beskrivelse,kodenr,art,box1,box2,box3,box4,box5) values ('Personlige valg','$bruger_id','USET','$jsvars','$popup','$sidemenu','$bgcolor','$nuance')",__FILE__ . " linje " . __LINE__);
		} elseif ($id>0) db_modify("update grupper set box1='$jsvars',box2='$popup',box3='$sidemenu',box4='$bgcolor',box5='$nuance' where id = '$id'",__FILE__ . " linje " . __LINE__);
		if ($refresh_opener) {
...
#		print "<td align = center><form name=impdeb action=\"exporter_debitor.php\"><input type=\"submit\" style=\"width: 8em\" value=\"Eksport&eacute;r\"></form></td></tr>\n\n";
		print "<tr><td colspan=3>Import&eacute;r varer</td>";
		print "<td align = center><form name=impvar action=\"importer_varer.php\"><input type=\"submit\" style=\"width: 8em\" value=\"Import&eacute;r\"></form></td></tr>\n\n";
	}
#	print "</tbody></table></td></tr>";
...
function personlige_valg() {
	...
	if ($r['box3']) $sidemenu='checked';
	if ($r['box4']) $bgcolor=$r['box4'];
	if ($r['box5']) $nuance=$r['box5'];
...
#	print "<input type=hidden name=id value='$id'>";
	...
	print "<tr><td title=\"".findtekst(316,$sprog_id)."\">".findtekst(315,$sprog_id)."</td><td><INPUT CLASS=\"inputbox\" TYPE=\"checkbox\" name=\"sidemenu\" $sidemenu></td></tr>";
