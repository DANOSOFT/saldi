...
#else
if ($art!='D') $felt_navn=array("kontonr","firmanavn","fornavn","efternavn","addr1","husnr","etage","addr2","postnr","bynavn","land","kontakt","tlf","mobile","email","web","notes","kreditmax","betalingsbet","betalingsdage","cvrnr","ean","bank_reg","bank_kto","institution","gruppe","kontoansvarlig","oprettet","felt_1","felt_2","felt_3","felt_4","felt_5","kategori","kontakt_navn","kontakt_addr1","kontakt_addr2","kontakt_postnr","kontakt_bynavn","kontakt_tlf","kontakt_mobile","kontakt_email","kontakt_notes");
else $felt_navn=array("kontonr","firmanavn","fornavn","efternavn","addr1","husnr","etage","addr2","postnr","bynavn","land","kontakt","tlf","mobile","email","web","notes","kreditmax","betalingsbet","betalingsdage","cvrnr","bank_reg","bank_kto","pbs_nr","gruppe","kontoansvarlig","oprettet","felt_1","felt_2","felt_3","felt_4","felt_5","kategori","kontakt_navn","kontakt_addr1","kontakt_addr2","kontakt_postnr","kontakt_bynavn","kontakt_tlf","kontakt_mobile","kontakt_email","kontakt_notes");
