...
if ($menu=='T') {  # 20150331 start
    ...
    print "<a title=\"Ny visuel formulareditor (træk og slip)\" class='button green small left' href=\"$fe_link\">Visuel editor</a> &nbsp;";
	...
	print "<td width='12%'><a href=\"$fe_link\" title='Ny visuel formulareditor (træk og slip)'><button style='$buttonStyle; width:100%' onMouseOver=\"this.style.cursor='pointer'\">Visuel editor</button></a></td>\n";
	...
	print "<td width=\"12%\" $top_bund><font face=\"Helvetica, Arial, sans-serif\" color=\"#000066\"><a href=\"$fe_link\" title=\"Ny visuel formulareditor\">Visuel editor</a></td>\n";
...
/*
	...
	print "<option>egen_mobile</option>";
