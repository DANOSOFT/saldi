<?php
// -------systemdata/ansatte.php--------lap 2.1.5-------2010-03-26-------
// LICENS
//
...
if ($_POST) {
	...
	$initialer=addslashes(trim($_POST['initialer']));
	...
	$privattlf=addslashes(trim($_POST['privattlf']));
	...
	if (($id==0)&&($navn)) {
		db_modify("insert into ansatte (navn, initialer, konto_id, addr1, addr2, postnr, bynavn, tlf, fax, privattlf, mobil, email, cprnr, notes, afd, lukket) values ('$navn', '$initialer', '$konto_id', '$addr1', '$addr2', '$postnr', '$bynavn', '$tlf', '$fax', '$privattlf', '$mobil', '$email', '$cprnr', '$notes', '$afd', '$lukket')",__FILE__ . " linje " . __LINE__);
		...
		db_modify("update ansatte set navn = '$navn', initialer='$initialer', konto_id = '$konto_id', addr1 = '$addr1', addr2 = '$addr2', postnr = '$postnr', bynavn = '$bynavn', email = '$email', tlf = '$tlf', fax = '$fax', privattlf= '$privattlf', mobil = '$mobil', cprnr = '$cprnr', notes = '$notes', afd = '$afd', lukket = '$lukket' where id = '$id'",__FILE__ . " linje " . __LINE__);
	}
...
print "<td>$font Navn</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=25 name=navn value='$navn'></td>";
print "<td><br></td>";
print "<td>$font Initialer</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=6 name=initialer value='$initialer'></td>";
print "<tr><td>$font Adresse</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=25 name=addr1 value='$addr1'></td>";
print "<td><br></td>";
print "<td>$font Adresse2</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=25 name=addr2 value='$addr2'></td></tr>";
print "<tr><td>$font Postnr</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=6 name=postnr value='$postnr'></td>";
print "<td><br></td>";
print "<td>$font By</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=25 name=bynavn value='$bynavn'></td></tr>";
print "<tr><td>$font E-mail</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=25 name=email value='$email'></td>";
print "<td><br></td>";
#print "<td>$font CVR. nr.</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=10 name=cprnr value='$cprnr'></td></tr>";
print "<td>$font Mobil</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=10 name=mobil value='$mobil'></td></tr>";
print "<tr><td>$font Lokalnr.</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=10 name=tlf value='$tlf'></td>";
print "<td><br></td>";
print "<td>$font Lokal fax</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=10 name=fax value='$fax'></td></tr>";
print "<tr><td>$font Privat tlf</td><td><br></td><td><input class=\"inputbox\" type=\"text\" size=10 name=privattlf value='$privattlf'></td>";
print "<td><br></td>";
...
# if (!db_fetch_array(db_select("SELECT attrelid FROM pg_attribute where attname='gruppe_id'",__FILE__ . " linje " . __LINE__))) {
...
while ($r1 = db_fetch_array($q1)) {
	...
	print "<td>$font $r1[beskrivelse]</td><td></td><td><input class=\"inputbox\" type=\"text\" style=text-align:right size=5 name=provision[$x] value='$provision'>%</td></tr>";	
