...
#		<input name='box6' type='checkbox' $box6></td></tr>";
	...
	print "<tr><td title='Skjul omsætning p&aring; ordrelisten og i kasseopt&aelig;llingen for brugere uden rettigheden Indstillinger. Brugere med rettigheden ser uændret.'>".findtekst('Skjul omsætning for brugere uden adgang til Indstillinger', $sprog_id)."</td><td><INPUT title='Skjul omsætning for brugere uden rettigheden Indstillinger' class='inputbox' type='checkbox' name='hideRevenue' $hideRevenue></td></tr>";
