...
if ($addUser || $updateUser) {
	...
	if ($addUser && $brugernavn) {
		...
		if ($row = db_fetch_array($query)) {
			...
			header("Location: brugerNewest.php");
			exit;
		}
	}
...
<div class="user-management-container">
	...
	if ($ret_id || $add):
		...
		<div class="user-header">
			...
			<a href="brugerNewest.php" class="btn btn-secondary">← <?php echo findtekst('1090|Tilbage', $sprog_id); ?></a>
		</div>
	...
	<?php else: 
		...
		<div class="user-header">
			...
			<a href="brugerNewest.php?add=1" class="btn btn-success">+ <?php echo findtekst('333|Ny bruger', $sprog_id); ?></a>
		</div>
			...
			while ($row = db_fetch_array($query)) {
				...
				<div class="user-card">
					<div class="user-card-header">
						<a href="brugerNewest.php?ret_id=<?php echo $row['id']; ?>" class="user-name">
					...
					<div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #f0f0f0; display: flex; justify-content: space-between; align-items: center;">
						...
						<?php else: ?>
							<span style="font-size: 12px; color: #666;"><?php echo findtekst('2562|Revisor', $sprog_id); ?></span>
						<?php endif; ?>
						<a href="brugerNewest.php?ret_id=<?php echo $row['id']; ?>" class="btn btn-primary" style="padding: 6px 12px; font-size: 12px;">
		...
		<?php if ($userCount == 0): ?>
			<div class="empty-state">
				...
				<a href="brugerNewest.php?add=1" class="btn btn-success" style="margin-top: 20px;">+ <?php echo findtekst('333|Ny bruger', $sprog_id); ?></a>
			</div>
		<?php endif; ?>
	...
	if ($ret_id || $add):
	?>
		<form name='bruger' action='brugerNewest.php' method='post'>
			<?php if ($ret_id): ?>
				<?php
				...
				<div class="button-group">
					...
					<a href="brugerNewest.php" class="btn btn-secondary"><?php echo findtekst('1090|Annuller', $sprog_id); ?></a>
				</div>
